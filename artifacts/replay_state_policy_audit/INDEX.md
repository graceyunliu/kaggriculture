...
| 9 | [REPORT_PHASE9_CHORE_PRIORITY.md](REPORT_PHASE9_CHORE_PRIORITY.md) | Mining campaign Lead 4: tested chore-type priority ordering (weeds moved ahead of harvest in _build_sweep's tier order). Consistently positive-signed effect across 4 independent seed/opponent tests, pooled t=1.97 (n=160) -- promising but below this audit's own established significance bar. Status: PARTIAL_EVIDENCE. |
