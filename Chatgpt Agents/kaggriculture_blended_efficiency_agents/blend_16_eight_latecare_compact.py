# BLENDED EFFICIENCY AGENT 16: eight_latecare_compact
# Objective: jointly improve turn, land, and labor efficiency.
# Policy: 8 hands, delay care until production ramp.
# Base: main_v8.3.py
...
def animal_maintenance_action(pos, view, shed, carry, day, hour, exclude=(), critical_only=False):
    ...
    needs_care = (not critical_only) and (day >= 6) and (not tile.get("cared_today", True))
