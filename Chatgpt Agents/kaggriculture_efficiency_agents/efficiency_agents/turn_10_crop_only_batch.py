# TURN EFFICIENCY AGENT 10: crop_only_batch
# Base: main_v8.3.py
# Objective: Avoid all animal setup and daily maintenance actions.
# Isolated policy changes: Disable sheep and close cow purchase window; melon/strawberry batch crop mix.
...
ANIMAL_SPECS = {
    ...
    "COW":   {"cost": 400, "min_money": 700, "start_day": 0,  "last_day": -1},
...
def economy(obs, me, opp, view, seeds, day, hour, timing_engine, animal_plans):
    ...
    if day <= CUTOFF["STRAWBERRY"] and budget > 900:
        ...
        want["STRAWBERRY"] = min(space, 10 if ph == 0 else 16)
