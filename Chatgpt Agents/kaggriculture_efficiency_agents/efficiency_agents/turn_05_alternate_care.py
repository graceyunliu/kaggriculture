# TURN EFFICIENCY AGENT 05: alternate_care
# Base: main_v8.3.py
# Objective: Capture some care bonus with half the routine care actions.
# Isolated policy changes: Care only on even-numbered days; fertilizer collection disabled.
