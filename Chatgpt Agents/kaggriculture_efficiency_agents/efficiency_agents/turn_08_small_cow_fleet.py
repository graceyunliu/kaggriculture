# TURN EFFICIENCY AGENT 08: small_cow_fleet
# Base: main_v8.3.py
# Objective: Limit daily maintenance actions while retaining premium animal output.
# Isolated policy changes: Disable sheep; stop cow purchases after day 12; lower animal labor weighting.
