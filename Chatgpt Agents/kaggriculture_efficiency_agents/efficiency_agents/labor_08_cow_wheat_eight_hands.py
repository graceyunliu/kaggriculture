# LABOR EFFICIENCY AGENT 08: cow_wheat_eight_hands
# Base: main_v8.3.py
# Objective: Use a constrained team on home-fed cows rather than a mixed premium fleet.
# Isolated policy changes: Eight-hand cap, sheep disabled, wheat-first portfolio, cows available through day 18.
...
PLANT_PRIORITY = ["WHEAT", "STRAWBERRY", "MELON", "TOMATO", "CARROT"]
...
def economy(obs, me, opp, view, seeds, day, hour, timing_engine, animal_plans):
    ...
    if day <= CUTOFF["MELON"] and budget > 700:
        melon_target = min(space, 4 if ph == 0 else 7)
