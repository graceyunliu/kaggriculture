# LABOR EFFICIENCY AGENT 02: eight_hand_cap
# Base: main_v8.3.py
# Objective: Use a moderate worker ceiling while preserving more throughput than the strict cap.
# Isolated policy changes: Hand target 3–8; maximum eight hires; seven work units per target hand.
