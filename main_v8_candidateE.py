...
def economy(obs, me, opp, view, seeds, day, hour, timing_engine, animal_plans):
    ...
    # v8E: crop population the plan is actively trying to reach this turn --
    # passed to _animal_expansion_feasible so a bigger want["WHEAT"] (or
    # slower planting for any reason) tightens the animal-purchase gate.
    standing_crop_demand = sum(want.values())
