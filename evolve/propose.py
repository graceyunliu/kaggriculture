...
PARAM_BLOCK = {
    "MAX_HANDS": "hiring", "HIRE_MAX_MARGINAL": "hiring", "load_per_hand": "hiring", "min_hands": "hiring",
    "demand_share": "demand",
    ...
    "ORCH_P_HARVEST": "sweep", "ORCH_P_WWATER": "sweep",
    "ORCH_P_FERT": "sweep", "ORCH_P_PLANT": "sweep",
    "ORCH_P_WATER": "sweep", "ORCH_P_WEEDS": "sweep",
    "ORCH_P_SLACK": "sweep", "ORCH_COMMIT": "sweep",
    "ORCH_SLACK_HOUR": "sweep",
    "fert_carry": "dispatch", "MELON_MORNING": "dispatch",
    "MELON_MORNING_LAST_HOUR": "dispatch", "MELON_MORNING_MIN_YIELD": "dispatch",
    "FERT_IS_INPUT": "dispatch",
}
