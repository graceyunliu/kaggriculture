...
Elapsed 0.03 h · candidates evaluated this run: 0 · games 608 (17,991/h)
...
Population (all runs, reached dev): 1309 · held-out evaluated: 908 · held-out PASS: 894
...
- best: best +15,151 (`51435ac9641b`), n=445
...
|---|---:|---|---|---:|---:|---:|---|
| ROUTE_LEN | +17,572 | 2 | 3 | 4 | 1309 | 1.69 | 2: +9,324 (n=880), 3: +5,324 (n=407), 4: +558 (n=19), 5: -8,248 (n=3) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| MAX_HANDS | +15,767 | 16 | 14 | 8 | 1309 | 1.71 | 16: +9,363 (n=444), 15: +8,613 (n=396), 13: +7,405 (n=40), 12: +7,140 (n=23), 14: +5,849 (n=396), 11: +4,653 (n=6), 10: -616 (n=2), 8: -6,404 (n=2) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| MELON_PRICE_CUSHION | +14,228 | 127 | 100 | 59 | 1291 | 23.23 | 127: +13,338 (n=3), 53: +12,736 (n=3), 73: +12,491 (n=2), 96: +12,316 (n=2), 50: +11,473 (n=2), 119: +11,101 (n=7), 86: +10,542 (n=8), 117: +10,236 (n=5), 146: +10,158 (n=2), 54: +10,157 (n=2), 133: +10,154 (n=2), 63: +9,835 (n=2), 82: +9,629 (n=156), 101: +9,491 (n=15), 103: +9,395 (n=3), 120: +9,100 (n=18), 92: +8,798 (n=2), 112: +8,421 (n=13), 68: +8,143 (n=29), 99: +8,109 (n=10), 100: +8,038 (n=763), 94: +7,681 (n=5), 111: +7,657 (n=10), 106: +6,902 (n=7), 148: +6,535 (n=2), 128: +6,238 (n=9), 114: +6,129 (n=2), 107: +6,042 (n=105), 131: +6,008 (n=4), 116: +5,946 (n=66), 93: +4,132 (n=5), 143: +3,933 (n=3), 136: +3,537 (n=3), 84: +3,424 (n=3), 87: +3,081 (n=2), 90: +2,614 (n=2), 134: +2,579 (n=5), 150: +2,409 (n=3), 85: +1,681 (n=2), 77: +1,272 (n=2), 118: -891 (n=2) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| wheat_stock | +12,201 | 3 | 0 | 22 | 1303 | 9.88 | 3: +9,705 (n=11), 13: +9,459 (n=4), 5: +8,960 (n=47), 4: +8,779 (n=7), 2: +8,548 (n=5), 0: +8,267 (n=886), 9: +8,158 (n=6), 10: +7,322 (n=12), 17: +7,175 (n=5), 7: +7,048 (n=7), 1: +6,924 (n=300), 6: +5,817 (n=2), 8: +5,801 (n=4), 12: +4,114 (n=3), 11: +3,818 (n=2), 22: -2,496 (n=2) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| max_animals | +10,951 | 16 | 17 | 11 | 1308 | 5.62 | 16: +9,891 (n=233), 15: +9,486 (n=98), 14: +7,876 (n=18), 17: +7,684 (n=866), 19: +7,051 (n=8), 13: +5,522 (n=3), 18: +3,827 (n=53), 20: +2,475 (n=21), 10: +50 (n=2), 12: -1,060 (n=6) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| open_melons | +10,867 | 7 | 10 | 11 | 1309 | 7.24 | 7: +10,175 (n=16), 11: +8,835 (n=45), 6: +8,358 (n=63), 9: +8,034 (n=980), 10: +7,635 (n=62), 8: +7,535 (n=91), 12: +6,812 (n=13), 5: +6,249 (n=8), 4: +4,075 (n=24), 13: +3,083 (n=2), 14: -692 (n=5) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| wheat_cap | +9,950 | 17 | 22 | 18 | 1306 | 6.17 | 17: +10,266 (n=9), 14: +10,167 (n=35), 24: +9,831 (n=3), 20: +9,826 (n=319), 11: +8,907 (n=8), 21: +7,500 (n=624), 23: +7,484 (n=4), 13: +7,078 (n=3), 22: +6,975 (n=168), 25: +6,768 (n=50), 16: +6,678 (n=2), 5: +6,304 (n=6), 19: +6,298 (n=5), 18: +5,651 (n=60), 15: +315 (n=10) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| opening | +9,158 | frontier | frontier | 2 | 1309 | 0.8 | frontier: +8,850 (n=1175), v312: -307 (n=134) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| MELON_MORNING_LAST_HOUR | +8,886 | 9 | 8 | 9 | 1309 | 3.35 | 9: +9,478 (n=632), 5: +8,778 (n=6), 10: +8,483 (n=25), 8: +6,907 (n=523), 7: +6,481 (n=13), 11: +5,572 (n=14), 4: +4,919 (n=22), 12: +3,159 (n=69), 6: +591 (n=5) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| open_sheep | +8,791 | 2 | 2 | 4 | 1309 | 2.74 | 2: +8,113 (n=1223), 1: +5,939 (n=65), 0: +3,948 (n=14), 3: -678 (n=7) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| wheat_sell_price | +8,511 | 37 | 30 | 20 | 1306 | 5.78 | 37: +10,903 (n=2), 33: +10,746 (n=3), 29: +9,006 (n=521), 31: +8,888 (n=7), 38: +8,824 (n=4), 25: +8,459 (n=321), 26: +8,112 (n=101), 34: +7,882 (n=14), 28: +7,487 (n=11), 27: +7,468 (n=13), 32: +7,212 (n=6), 42: +6,558 (n=17), 36: +6,390 (n=5), 35: +5,648 (n=12), 30: +5,404 (n=260), 43: +3,122 (n=6), 40: +2,392 (n=3) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| MAX_SHEEP | +7,663 | 13 | 14 | 9 | 1306 | 3.19 | 13: +9,568 (n=333), 12: +8,025 (n=12), 14: +7,599 (n=912), 11: +6,378 (n=6), 9: +3,489 (n=21), 10: +1,905 (n=22) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| OPP_GROWTH | +7,566 | 1.1 | 1.4 | 9 | 1309 | 2.25 | 1.1: +9,858 (n=389), 1.5: +8,707 (n=139), 1.2: +7,681 (n=101), 1.3: +6,994 (n=472), 1.4: +6,571 (n=140), 1.6: +5,768 (n=11), 1.0: +5,669 (n=31), 1.8: +4,494 (n=8), 1.7: +2,292 (n=18) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| load_per_hand | +7,497 | 21 | 20 | 15 | 1307 | 6.54 | 21: +9,804 (n=35), 19: +9,629 (n=266), 20: +7,853 (n=758), 16: +7,606 (n=22), 17: +7,448 (n=82), 18: +7,305 (n=50), 22: +6,145 (n=16), 14: +5,695 (n=9), 23: +5,345 (n=8), 24: +4,275 (n=5), 13: +3,027 (n=3), 15: +2,342 (n=46), 12: +2,307 (n=7) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| demand_share | +7,008 | 0.4 | 0.55 | 14 | 1308 | 9.21 | 0.4: +10,525 (n=6), 0.55: +8,318 (n=1027), 0.75: +7,930 (n=8), 0.45: +7,713 (n=24), 0.6: +7,341 (n=29), 0.5: +7,281 (n=113), 0.35: +6,190 (n=9), 0.85: +6,097 (n=2), 0.65: +5,727 (n=19), 0.8: +4,477 (n=18), 0.7: +4,110 (n=35), 0.9: +3,786 (n=3), 0.3: +3,516 (n=15) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| STRAW_CUTOFF | +6,672 | 16 | 19 | 8 | 1308 | 4.78 | 16: +9,342 (n=50), 19: +7,966 (n=1080), 18: +7,685 (n=18), 17: +7,460 (n=19), 20: +7,197 (n=136), 14: +5,891 (n=2), 15: +2,670 (n=3) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| OPENING_MELONS | +5,697 | 8 | 14 | 7 | 1309 | 3.52 | 8: +11,498 (n=4), 10: +9,818 (n=4), 11: +9,609 (n=125), 13: +9,457 (n=295), 12: +8,405 (n=31), 14: +7,090 (n=846), 9: +5,801 (n=4) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| HIRE_MAX_MARGINAL | +5,352 | 233 | 144 | 6 | 1309 | 3.39 | 233: +9,204 (n=208), 1000000000: +8,089 (n=27), 144: +7,870 (n=957), 89: +6,584 (n=57), 377: +6,158 (n=38), 55: +3,853 (n=22) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| setup_capital_share | +5,027 | 0.15 | 0.25 | 2 | 347 | 0.97 | 0.15: +12,680 (n=5), 0.25: +7,653 (n=342) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| feed_spare_poor | +4,476 | 1 | 0 | 4 | 1309 | 2.26 | 1: +9,445 (n=213), 0: +7,641 (n=1066), 2: +7,151 (n=24), 3: +4,969 (n=6) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
...
_Generated 2026-09-15 07:26. Candidate files in `evolve/gen/`, DB `evolve/evolve.db`._
...
**1309 candidates** with action_table data, **179034 total action events** extracted (SELL/BUY item counts are averaged across the 5 trajectory seeds — see trace.py SUMMARY_FIELDS).

Action timing vs outcome correlation. For each action type, the table shows mean dev_margin of candidates that performed that action in each horizon bucket. Higher dev_margin = better outcome. This is NOT causal — a candidate that sells early may also have other good properties. Use as a guide for what to test, not as a proven mechanism.

| action_type | early (days 1-14) | mid (days 15-21) | late (days 22-29) | total events |
|---|---|---:|---|---|---:|
| SELL |         +7,951 (n=17669) |         +7,913 (n=9163) |         +7,913 (n=10472) | 37304 |
| BUY_ANIMAL |         +7,582 (n=8726) |         +7,707 (n=2025) |              — (n=0) | 10751 |
| BUY_SEED |         +8,129 (n=14550) |         +7,946 (n=4846) |         +7,657 (n=1933) | 21329 |
| BUY_LAND |         +8,070 (n=4910) |         +7,794 (n=971) |              — (n=0) | 5881 |
| BUY_PRODUCT |         +7,913 (n=19614) |         +7,913 (n=9163) |         +7,945 (n=8971) | 37748 |
| HIRE |         +7,931 (n=9888) |         +7,985 (n=4747) |         +8,255 (n=3244) | 17879 |
| WATER_MISSED |         +8,080 (n=15470) |         +7,913 (n=9163) |         +7,923 (n=10361) | 34994 |
  _Water missed = postponement signal. Negative = candidates that missed water had lower dev_margin._
| FEED_MISSED |         +7,689 (n=7913) |         +6,751 (n=2349) |         +7,317 (n=2886) | 13148 |
...
|---|---|---:|---:|---:|---:|---:|---:|
| SELL |      +8,023 |      +7,924 |      +7,607 |      +8,440 |      +7,791 |      +7,891 |
| BUY_ANIMAL |      +7,069 |           — |           — |         -35 |      +8,850 |      +7,529 |
| BUY_SEED |      +7,869 |      +8,334 |      +4,937 |      +2,645 |      +9,043 |      +8,002 |
| BUY_LAND |           — |      +2,628 |      +7,963 |      +1,577 |      +8,288 |      +8,112 |
| BUY_PRODUCT |      +7,921 |           — |           — |           — |           — |           — |
| HIRE |      +8,004 |           — |           — |           — |           — |           — |
| WATER_MISSED |           — |           — |      +7,913 |      +8,437 |      +7,913 |      +7,980 |
| FEED_MISSED |           — |      +7,931 |      +5,568 |           — |           — |      +7,403 |
...
|---|---|---:|---:|---:|---:|
| 1 | HIRE | late | +8,255 | 3244 | 1.82 |
| 2 | BUY_SEED | early | +8,129 | 14550 | 1.81 |
| 3 | WATER_MISSED | early | +8,080 | 15470 | 1.8 |
| 4 | BUY_LAND | early | +8,070 | 4910 | 1.75 |
| 5 | HIRE | mid | +7,985 | 4747 | 1.71 |
| 6 | SELL | early | +7,951 | 17669 | 1.74 |
| 7 | BUY_SEED | mid | +7,946 | 4846 | 1.69 |
| 8 | BUY_PRODUCT | late | +7,945 | 8971 | 1.72 |
| 9 | HIRE | early | +7,931 | 9888 | 1.7 |
| 10 | WATER_MISSED | late | +7,923 | 10361 | 1.71 |
...
- **FEED_MISSED** in ('low', 'low', 'low', 'mid'): +9,633 (n=251)
- **SELL** in ('low', 'low', 'low', 'mid'): +9,617 (n=255)
- **BUY_PRODUCT** in ('low', 'low', 'low', 'mid'): +9,617 (n=255)
- **WATER_MISSED** in ('low', 'low', 'low', 'mid'): +9,610 (n=236)
- **BUY_ANIMAL** in ('low', 'low', 'low', 'mid'): +9,607 (n=253)
...
- **BUY_SEED** in ('low', 'mid', 'high', 'high'): +9,101 (n=859)
- **FEED_MISSED** in ('low', 'low', 'low', 'high'): +9,077 (n=1827)
