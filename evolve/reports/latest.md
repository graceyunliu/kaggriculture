...
Elapsed 0.05 h · candidates evaluated this run: 4 · games 954 (17,769/h)
...
Population (all runs, reached dev): 2022 · held-out evaluated: 908 · held-out PASS: 894
...
- best: best +15,151 (`51435ac9641b`), n=725
- o15: best +14,660 (`a75ac7f5628a`), n=426
- queue: best +14,471 (`5716cad50618`), n=373
- wide: best +14,856 (`69f83ba942be`), n=498
...
|---|---:|---|---|---:|---:|---:|---|
| max_animals | +15,937 | 16 | 17 | 11 | 2022 | 4.84 | 16: +9,646 (n=385), 15: +8,277 (n=208), 17: +6,929 (n=1073), 18: +3,762 (n=64), 19: +3,624 (n=25), 20: +2,614 (n=26), 14: +721 (n=143), 13: -66 (n=16), 12: -4,075 (n=71), 10: -4,731 (n=8), 11: -6,291 (n=3) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| ROUTE_LEN | +15,326 | 2 | 3 | 4 | 2022 | 2.06 | 2: +7,078 (n=1545), 3: +4,732 (n=448), 4: -218 (n=26), 5: -8,248 (n=3) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| MELON_PRICE_CUSHION | +14,993 | 81 | 100 | 74 | 2005 | 25.55 | 81: +13,020 (n=2), 53: +12,736 (n=3), 73: +12,491 (n=2), 60: +11,063 (n=4), 86: +10,542 (n=8), 112: +10,355 (n=53), 54: +10,157 (n=2), 146: +10,055 (n=3), 119: +9,950 (n=8), 82: +9,845 (n=247), 63: +9,835 (n=2), 50: +9,759 (n=8), 103: +9,744 (n=6), 127: +9,392 (n=21), 99: +8,609 (n=11), 88: +8,576 (n=2), 96: +8,485 (n=3), 68: +8,143 (n=29), 80: +8,105 (n=14), 94: +7,681 (n=5), 100: +7,158 (n=934), 106: +7,054 (n=10), 120: +6,885 (n=27), 148: +6,535 (n=2), 87: +6,450 (n=3), 114: +6,129 (n=2), 116: +5,946 (n=66), 84: +5,799 (n=4), 93: +5,643 (n=6), 128: +5,640 (n=11), 105: +5,364 (n=3), 101: +5,265 (n=21), 125: +4,027 (n=3), 143: +3,933 (n=3), 131: +3,889 (n=5), 136: +3,537 (n=3), 117: +3,123 (n=25), 107: +2,892 (n=290), 108: +2,827 (n=3), 92: +2,237 (n=4), 58: +2,196 (n=8), 150: +1,841 (n=6), 85: +1,681 (n=2), 111: +1,665 (n=28), 66: +1,516 (n=2), 77: +1,272 (n=2), 134: +712 (n=7), 113: +600 (n=36), 133: +586 (n=7), 90: +440 (n=3), 76: +408 (n=5), 118: +247 (n=9), 89: -147 (n=2), 83: -215 (n=9), 102: -665 (n=2), 110: -943 (n=17), 137: -1,973 (n=2) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| MAX_HANDS | +13,891 | 15 | 14 | 8 | 2022 | 2.0 | 15: +7,486 (n=600), 16: +7,169 (n=757), 13: +5,386 (n=77), 14: +4,721 (n=527), 11: +4,578 (n=8), 12: +3,859 (n=48), 10: -1,909 (n=3), 8: -6,404 (n=2) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| MAX_SHEEP | +13,275 | 13 | 14 | 10 | 2020 | 4.91 | 13: +9,216 (n=415), 14: +6,017 (n=1493), 12: +5,628 (n=25), 8: +4,024 (n=4), 9: +1,732 (n=29), 10: +751 (n=28), 11: +511 (n=23), 4: -4,059 (n=3) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| wheat_stock | +12,264 | 3 | 0 | 28 | 2013 | 13.66 | 3: +9,768 (n=13), 5: +8,908 (n=54), 4: +8,779 (n=7), 9: +8,563 (n=8), 2: +7,341 (n=8), 17: +7,175 (n=5), 1: +7,062 (n=316), 7: +7,048 (n=7), 10: +6,704 (n=15), 0: +6,214 (n=1553), 6: +5,817 (n=2), 8: +5,801 (n=4), 13: +5,607 (n=6), 12: +4,275 (n=5), 11: +3,818 (n=2), 25: +1,654 (n=2), 40: +930 (n=2), 14: +563 (n=2), 22: -2,496 (n=2) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| MELON_MORNING_LAST_HOUR | +11,304 | 9 | 8 | 9 | 2022 | 3.24 | 9: +8,959 (n=953), 11: +7,626 (n=21), 5: +7,230 (n=8), 10: +4,798 (n=80), 8: +4,647 (n=731), 4: +4,490 (n=52), 12: +1,800 (n=105), 7: +1,320 (n=64), 6: -2,345 (n=8) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| wheat_sell_price | +10,792 | 37 | 30 | 21 | 2021 | 6.7 | 37: +10,903 (n=2), 29: +8,733 (n=778), 25: +8,237 (n=395), 27: +7,664 (n=18), 26: +6,904 (n=121), 42: +6,603 (n=18), 31: +5,392 (n=13), 33: +4,912 (n=9), 34: +4,621 (n=25), 39: +4,307 (n=3), 36: +3,865 (n=8), 35: +3,401 (n=17), 44: +3,195 (n=2), 43: +3,122 (n=6), 30: +2,585 (n=521), 28: +2,374 (n=39), 40: +2,251 (n=4), 38: +1,922 (n=10), 32: +972 (n=30), 41: +110 (n=2) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| load_per_hand | +10,346 | 19 | 20 | 15 | 2022 | 7.72 | 19: +9,415 (n=405), 21: +8,354 (n=59), 17: +7,375 (n=87), 16: +6,975 (n=29), 14: +6,635 (n=11), 18: +6,201 (n=59), 20: +5,990 (n=1175), 23: +4,642 (n=13), 24: +3,812 (n=8), 22: +3,011 (n=85), 25: +1,253 (n=6), 15: +854 (n=64), 13: -83 (n=5), 26: -177 (n=6), 12: -931 (n=10) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| early_hire_days | +9,583 | 8 | 3 | 9 | 2022 | 2.59 | 8: +9,618 (n=807), 6: +7,323 (n=30), 7: +6,858 (n=22), 5: +6,506 (n=669), 2: +4,823 (n=81), 4: +2,345 (n=39), 0: +2,127 (n=16), 1: +1,451 (n=8), 3: +35 (n=350) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| open_melons | +9,389 | 9 | 10 | 11 | 2022 | 6.17 | 9: +7,967 (n=1318), 6: +6,932 (n=78), 7: +6,879 (n=23), 8: +6,501 (n=117), 5: +6,249 (n=8), 11: +6,135 (n=66), 12: +5,489 (n=19), 4: +3,991 (n=25), 10: +1,154 (n=357), 13: +1,000 (n=4), 14: -1,422 (n=7) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| opening | +9,094 | frontier | frontier | 2 | 2022 | 0.78 | frontier: +7,454 (n=1797), v312: -1,640 (n=225) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| OPP_GROWTH | +9,059 | 1.1 | 1.4 | 9 | 2022 | 1.82 | 1.1: +9,659 (n=626), 1.5: +8,068 (n=171), 1.3: +5,524 (n=634), 1.2: +5,286 (n=156), 1.6: +4,787 (n=15), 1.0: +3,604 (n=79), 1.4: +3,112 (n=276), 1.7: +1,476 (n=20), 1.8: +601 (n=45) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| wheat_cap | +8,937 | 14 | 22 | 18 | 2019 | 4.11 | 14: +9,904 (n=41), 20: +9,629 (n=536), 17: +9,101 (n=13), 11: +8,240 (n=19), 21: +7,478 (n=688), 13: +5,940 (n=4), 19: +5,790 (n=9), 18: +5,639 (n=67), 5: +4,810 (n=8), 24: +4,000 (n=13), 25: +2,688 (n=163), 23: +2,582 (n=41), 22: +2,303 (n=398), 15: +1,557 (n=11), 16: +968 (n=8) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| OPENING_MELONS | +8,853 | 10 | 14 | 9 | 2021 | 3.87 | 10: +10,817 (n=8), 11: +9,695 (n=182), 13: +9,380 (n=519), 8: +8,647 (n=6), 12: +5,155 (n=63), 14: +4,793 (n=1230), 9: +4,329 (n=5), 7: +1,964 (n=8) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| harvest_min | +8,706 | 2 | 1 | 3 | 485 | 1.76 | 2: +8,223 (n=18), 1: +5,902 (n=447), 3: -483 (n=20) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| wheat_per_animal | +8,409 | 0.0 | 0.0 | 11 | 2019 | 6.26 | 0.0: +6,809 (n=1833), 0.3: +6,485 (n=21), 0.2: +5,844 (n=45), 0.1: +2,573 (n=51), 0.5: +2,323 (n=9), 0.4: +2,280 (n=23), 0.6: -1,147 (n=19), 0.7: -1,599 (n=18) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| fert_carry | +8,039 | 2 | 2 | 3 | 484 | 0.99 | 2: +5,748 (n=482), 1: -2,291 (n=2) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| open_sheep | +7,925 | 2 | 2 | 4 | 2022 | 2.69 | 2: +6,767 (n=1867), 1: +3,538 (n=103), 0: +2,484 (n=24), 3: -1,158 (n=28) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| STRAW_CUTOFF | +7,851 | 16 | 19 | 9 | 2021 | 5.39 | 16: +8,426 (n=86), 20: +6,625 (n=242), 19: +6,386 (n=1614), 14: +5,891 (n=2), 18: +5,456 (n=36), 17: +4,949 (n=35), 15: +3,015 (n=4), 12: +575 (n=2) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
...
_Generated 2026-09-16 09:05. Candidate files in `evolve/gen/`, DB `evolve/evolve.db`._
...
**2022 candidates** with action_table data, **275326 total action events** extracted (SELL/BUY item counts are averaged across the 5 trajectory seeds — see trace.py SUMMARY_FIELDS).

Action timing vs outcome correlation. For each action type, the table shows mean dev_margin of candidates that performed that action in each horizon bucket. Higher dev_margin = better outcome. This is NOT causal — a candidate that sells early may also have other good properties. Use as a guide for what to test, not as a proven mechanism.

| action_type | early (days 1-14) | mid (days 15-21) | late (days 22-29) | total events |
|---|---|---:|---|---|---:|
| SELL |         +6,487 (n=27301) |         +6,442 (n=14154) |         +6,442 (n=16176) | 57631 |
| BUY_ANIMAL |         +6,127 (n=13397) |         +6,353 (n=3052) |              — (n=0) | 16449 |
| BUY_SEED |         +6,803 (n=22050) |         +6,324 (n=7572) |         +5,993 (n=3101) | 32723 |
| BUY_LAND |         +6,631 (n=7607) |         +5,822 (n=1575) |              — (n=0) | 9182 |
| BUY_PRODUCT |         +6,445 (n=30287) |         +6,442 (n=14154) |         +6,480 (n=13811) | 58252 |
| HIRE |         +6,581 (n=15072) |         +6,459 (n=7485) |         +7,063 (n=4944) | 27501 |
| WATER_MISSED |         +6,713 (n=23518) |         +6,442 (n=14154) |         +6,450 (n=16000) | 53672 |
  _Water missed = postponement signal. Negative = candidates that missed water had lower dev_margin._
| FEED_MISSED |         +6,297 (n=12137) |         +5,674 (n=3421) |         +6,039 (n=4358) | 19916 |
...
|---|---|---:|---:|---:|---:|---:|---:|
| SELL |      +6,568 |      +6,446 |      +6,121 |      +7,434 |      +6,400 |      +6,374 |
| BUY_ANIMAL |      +5,569 |           — |           — |         -35 |      +7,454 |      +6,100 |
| BUY_SEED |      +6,697 |      +6,997 |      +3,244 |      +1,414 |      +7,559 |      +6,532 |
| BUY_LAND |           — |      +3,080 |      +6,545 |      -1,943 |      +7,525 |      +6,493 |
| BUY_PRODUCT |      +6,452 |           — |           — |           — |           — |           — |
| HIRE |      +6,634 |           — |           — |           — |           — |           — |
| WATER_MISSED |           — |           — |      +6,442 |      +7,805 |      +6,442 |      +6,533 |
| FEED_MISSED |           — |      +6,461 |      +4,670 |           — |           — |      +6,109 |
...
|---|---|---:|---:|---:|---:|
| 1 | HIRE | late | +7,063 | 4944 | 1.25 |
| 2 | BUY_SEED | early | +6,803 | 22050 | 1.19 |
| 3 | WATER_MISSED | early | +6,713 | 23518 | 1.18 |
| 4 | BUY_LAND | early | +6,631 | 7607 | 1.13 |
| 5 | HIRE | early | +6,581 | 15072 | 1.13 |
| 6 | SELL | early | +6,487 | 27301 | 1.12 |
| 7 | BUY_PRODUCT | late | +6,480 | 13811 | 1.11 |
| 8 | HIRE | mid | +6,459 | 7485 | 1.09 |
| 9 | WATER_MISSED | late | +6,450 | 16000 | 1.1 |
| 10 | BUY_PRODUCT | early | +6,445 | 30287 | 1.1 |
...
- **BUY_LAND** in ('mid', 'mid', 'mid', 'high'): +8,223 (n=1216)
- **BUY_SEED** in ('low', 'mid', 'high', 'high'): +7,989 (n=1277)
- **WATER_MISSED** in ('mid', 'low', 'mid', 'high'): +7,807 (n=220)
- **SELL** in ('low', 'low', 'mid', 'mid'): +7,684 (n=1581)
- **FEED_MISSED** in ('low', 'low', 'low', 'high'): +7,511 (n=2769)
- **BUY_LAND** in ('mid', 'low', 'mid', 'high'): +7,475 (n=230)
- **FEED_MISSED** in ('mid', 'mid', 'mid', 'high'): +7,446 (n=1388)
- **HIRE** in ('low', 'mid', 'low', 'high'): +7,423 (n=453)
