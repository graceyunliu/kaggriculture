...
Elapsed 2.02 h · candidates evaluated this run: 92 · games 28,594 (14,161/h)
...
Population (all runs, reached dev): 848 · held-out evaluated: 708 · held-out PASS: 700
...
| `af2beb49a48a` | queue | ablate:wheat_water_tier | **+14,831** | 11.3 | 20-0 | -11,706 | +12,333 | min_hands 3→4, open_melons 10→9, early_hire_days 3→8, max_animals 17→16, wheat_cap 22→21, wheat_sell_price 30→29, MAX_HANDS 14→15, ROUTE_LEN 3→2, CROP_SWEEP_LEN 6→8, HERD_LAST_DAY 17→20, NEAR_RADIUS 2→5, OPP_GROWTH 1.4→1.1, MAX_SHEEP 14→13, FERT_RADIUS 3→1, SPREAD_CAP 3→6, MELON_MORNING 1→0, MELON_MORNING_LAST_HOUR 8→9 |  | cand vs C1: net worth never diverged by >$1,500 (final +577). |
...
| `93d83c7d4d8c` | best | ablate:feed_spare_poor | +13,057 | 10.8 | 29-1 | -7,632 | held_pass | wheat_tiles 0→1, wheat_stock 0→5, load_per_hand 20→19, open_melons 10→9, early_hire_days 3→8, fert_buy 4→3, max_animals 17→16, wheat_cap 22→20, wheat_water_tier 0→1, wheat_sell_price 30→25, MAX_HANDS 14→16, ROUTE_LEN 3→2, CROP_SWEEP_LEN 6→8, CROP_SWEEP_RADIUS 5→4, HERD_LAST_DAY 17→20, NEAR_RADIUS 2→5, OPP_GROWTH 1.4→1.1, MAX_SHEEP 14→13, OPENING_MELONS 14→13, FERT_RADIUS 3→1, SPREAD_CAP 3→6, MELON_MORNING 1→0, MELON_MORNING_LAST_HOUR 8→9 |
...
- best: best +13,448 (`7f4c20265c65`), n=237
- o15: best +13,356 (`df998e33b31a`), n=208
- queue: best +13,464 (`5415f894f02c`), n=216
- wide: best +14,255 (`753a5a1fa946`), n=187
...
|---|---:|---|---|---:|---:|---:|---|
| ROUTE_LEN | +17,128 | 2 | 3 | 4 | 848 | 1.27 | 2: +8,880 (n=481), 3: +5,174 (n=351), 4: +708 (n=13), 5: -8,248 (n=3) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| max_animals | +13,306 | 16 | 17 | 10 | 846 | 5.35 | 16: +9,724 (n=65), 15: +8,113 (n=44), 17: +7,381 (n=671), 14: +6,845 (n=7), 19: +5,150 (n=5), 20: +1,702 (n=17), 18: +1,002 (n=34), 12: -3,582 (n=3) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| MELON_PRICE_CUSHION | +13,291 | 86 | 100 | 42 | 829 | 13.95 | 86: +12,149 (n=4), 101: +10,374 (n=12), 63: +9,835 (n=2), 92: +8,798 (n=2), 68: +8,782 (n=25), 82: +8,705 (n=56), 99: +8,109 (n=10), 111: +7,900 (n=9), 100: +7,651 (n=539), 120: +7,386 (n=4), 112: +6,296 (n=7), 131: +6,008 (n=4), 116: +5,986 (n=65), 93: +5,956 (n=4), 128: +5,869 (n=8), 136: +4,005 (n=2), 84: +3,424 (n=3), 107: +3,276 (n=61), 87: +3,081 (n=2), 94: +2,821 (n=2), 90: +2,614 (n=2), 134: +1,992 (n=4), 150: -1,142 (n=2) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| wheat_stock | +13,251 | 5 | 0 | 15 | 847 | 7.6 | 5: +10,755 (n=9), 9: +9,906 (n=4), 13: +9,459 (n=4), 10: +7,759 (n=6), 0: +7,314 (n=520), 1: +6,930 (n=281), 2: +6,692 (n=3), 4: +6,562 (n=4), 7: +5,922 (n=4), 17: +5,822 (n=3), 8: +4,263 (n=3), 3: +2,016 (n=2), 12: +816 (n=2), 22: -2,496 (n=2) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| load_per_hand | +12,291 | 19 | 20 | 14 | 847 | 7.6 | 19: +9,300 (n=75), 21: +8,355 (n=9), 20: +7,485 (n=560), 18: +6,920 (n=42), 16: +6,815 (n=18), 17: +6,699 (n=67), 14: +6,215 (n=5), 22: +5,960 (n=13), 24: +4,509 (n=4), 23: +4,148 (n=6), 13: +3,027 (n=3), 15: +2,062 (n=43), 12: -2,992 (n=2) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| STRAW_CUTOFF | +11,711 | 16 | 19 | 7 | 847 | 4.12 | 16: +9,963 (n=10), 19: +7,358 (n=723), 17: +6,986 (n=17), 18: +6,059 (n=7), 20: +5,621 (n=88), 15: -1,749 (n=2) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| MELON_MORNING_LAST_HOUR | +11,637 | 9 | 8 | 9 | 848 | 4.05 | 9: +9,228 (n=261), 10: +8,817 (n=12), 5: +8,778 (n=6), 7: +7,001 (n=10), 8: +6,855 (n=476), 4: +5,168 (n=19), 11: +2,634 (n=9), 12: +1,172 (n=51), 6: -2,409 (n=4) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| wheat_cap | +10,200 | 14 | 22 | 16 | 844 | 5.9 | 14: +10,516 (n=5), 20: +10,106 (n=86), 24: +9,483 (n=2), 17: +8,319 (n=3), 21: +7,187 (n=485), 22: +6,830 (n=154), 23: +6,419 (n=3), 25: +6,188 (n=34), 5: +5,663 (n=5), 18: +5,375 (n=53), 19: +4,771 (n=4), 15: +315 (n=10) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| MAX_HANDS | +9,265 | 16 | 14 | 8 | 847 | 1.76 | 16: +8,649 (n=176), 15: +8,400 (n=274), 13: +7,831 (n=37), 12: +7,231 (n=21), 14: +5,429 (n=334), 11: +1,232 (n=3), 10: -616 (n=2) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| MAX_SHEEP | +9,184 | 13 | 14 | 8 | 846 | 3.84 | 13: +9,913 (n=118), 14: +6,995 (n=683), 12: +5,745 (n=7), 11: +4,670 (n=4), 9: +3,268 (n=18), 10: +728 (n=16) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| open_sheep | +9,172 | 2 | 2 | 4 | 848 | 2.68 | 2: +7,365 (n=781), 1: +5,770 (n=52), 0: +2,843 (n=10), 3: -1,807 (n=5) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| opening | +9,089 | frontier | frontier | 2 | 848 | 0.78 | frontier: +8,157 (n=755), v312: -932 (n=93) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| OPP_GROWTH | +9,031 | 1.1 | 1.4 | 9 | 848 | 3.11 | 1.1: +9,810 (n=89), 1.5: +8,550 (n=111), 1.2: +7,425 (n=85), 1.4: +6,642 (n=135), 1.3: +6,615 (n=387), 1.0: +6,171 (n=11), 1.6: +5,782 (n=9), 1.8: +4,400 (n=7), 1.7: +779 (n=14) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| open_melons | +8,571 | 6 | 10 | 11 | 848 | 6.93 | 6: +8,570 (n=47), 7: +8,446 (n=5), 11: +8,322 (n=25), 10: +7,457 (n=46), 9: +7,193 (n=611), 8: +7,035 (n=70), 12: +7,017 (n=11), 5: +6,010 (n=7), 4: +3,144 (n=20), 13: +3,083 (n=2), 14: +0 (n=4) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| wheat_sell_price | +8,511 | 37 | 30 | 16 | 848 | 4.08 | 37: +10,903 (n=2), 31: +10,336 (n=2), 38: +8,245 (n=3), 29: +8,122 (n=269), 28: +8,109 (n=2), 34: +8,100 (n=10), 26: +8,089 (n=87), 25: +8,010 (n=201), 27: +7,038 (n=9), 36: +6,390 (n=5), 42: +6,226 (n=14), 32: +6,101 (n=5), 35: +5,490 (n=5), 30: +5,077 (n=225), 43: +3,122 (n=6), 40: +2,392 (n=3) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| demand_share | +7,526 | 0.4 | 0.55 | 11 | 848 | 7.65 | 0.4: +9,871 (n=2), 0.75: +8,155 (n=5), 0.55: +7,549 (n=667), 0.5: +6,900 (n=96), 0.35: +6,363 (n=4), 0.45: +5,678 (n=8), 0.6: +5,057 (n=13), 0.3: +4,559 (n=7), 0.8: +4,434 (n=8), 0.65: +4,063 (n=12), 0.7: +2,345 (n=26) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| min_hands | +5,930 | 4 | 3 | 4 | 848 | 2.53 | 4: +7,992 (n=75), 5: +7,644 (n=23), 3: +7,076 (n=748), 6: +2,061 (n=2) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| HIRE_MAX_MARGINAL | +5,647 | 233 | 144 | 6 | 848 | 3.78 | 233: +8,522 (n=67), 1000000000: +8,131 (n=21), 144: +7,229 (n=675), 89: +5,915 (n=40), 377: +5,886 (n=28), 55: +2,875 (n=17) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| labor_reserve_buffer | +5,179 | 37 | 92 | 2 | 238 | 0.96 | 37: +12,509 (n=5), 92: +7,329 (n=233) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| wheat_per_animal | +4,927 | 0.0 | 0.0 | 9 | 846 | 5.48 | 0.0: +7,380 (n=783), 0.2: +5,273 (n=31), 0.5: +4,734 (n=6), 0.3: +4,581 (n=10), 0.1: +4,390 (n=9), 0.6: +2,890 (n=3), 0.4: +2,453 (n=4) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
...
_Generated 2026-09-14 09:09. Candidate files in `evolve/gen/`, DB `evolve/evolve.db`._

## Recent failure observations (grouped by failure class)

**Observational only. Correlations, not established causes.** These groups describe parameter ranges frequently seen in recent failures of each class. A parameter appearing here may be part of the failure mechanism, or it may be confounded by the companion parameters tested alongside it, the seeds/matchups used, or RNG-path effects. Do not interpret these as 'avoid this parameter range.'

### EXECUTION_FAILURE (observed in 150 recent candidates)

- **Observed outcome:** unknown
- **Associated parameter ranges (correlation, not cause):** wheat_tiles=0–4 (n=150); wheat_stock=0–26 (n=150); min_hands=3–5 (n=150); load_per_hand=12–26 (n=150); open_melons=4–14 (n=150); open_cows=1–3 (n=150); open_sheep=0–3 (n=150); early_hire_days=0–8 (n=150)
- **Evidence:** 150 candidates, multiple seeds. Confidence: high

## Action timing patterns (AGE-359: observational — correlations, not causes)

**848 candidates** with action_table data, **115777 total action events** extracted (SELL/BUY item counts are averaged across the 5 trajectory seeds — see trace.py SUMMARY_FIELDS).

Action timing vs outcome correlation. For each action type, the table shows mean dev_margin of candidates that performed that action in each horizon bucket. Higher dev_margin = better outcome. This is NOT causal — a candidate that sells early may also have other good properties. Use as a guide for what to test, not as a proven mechanism.

| action_type | early (days 1-14) | mid (days 15-21) | late (days 22-29) | total events |
|---|---|---:|---|---|---:|
| SELL |         +7,205 (n=11419) |         +7,160 (n=5936) |         +7,160 (n=6784) | 24139 |
| BUY_ANIMAL |         +6,897 (n=5744) |         +6,980 (n=1266) |              — (n=0) | 7010 |
| BUY_SEED |         +7,368 (n=9363) |         +7,187 (n=3131) |         +6,927 (n=1266) | 13760 |
| BUY_LAND |         +7,265 (n=3118) |         +7,040 (n=612) |              — (n=0) | 3730 |
| BUY_PRODUCT |         +7,160 (n=12705) |         +7,160 (n=5936) |         +7,178 (n=5830) | 24471 |
| HIRE |         +7,161 (n=6377) |         +7,247 (n=3029) |         +7,463 (n=2049) | 11455 |
| WATER_MISSED |         +7,354 (n=10010) |         +7,160 (n=5936) |         +7,172 (n=6707) | 22653 |
  _Water missed = postponement signal. Negative = candidates that missed water had lower dev_margin._
| FEED_MISSED |         +6,958 (n=5153) |         +5,915 (n=1513) |         +6,489 (n=1893) | 8559 |
...
|---|---|---:|---:|---:|---:|---:|---:|
| SELL |      +7,288 |      +7,171 |      +6,958 |      +7,676 |      +7,050 |      +7,128 |
| BUY_ANIMAL |      +6,296 |           — |           — |           — |      +8,157 |      +6,853 |
| BUY_SEED |      +7,095 |      +7,505 |      +4,572 |      +2,355 |      +8,302 |      +7,250 |
| BUY_LAND |           — |      +2,337 |      +7,223 |        +698 |      +7,412 |      +7,337 |
| BUY_PRODUCT |      +7,164 |           — |           — |           — |           — |           — |
| HIRE |      +7,238 |           — |           — |           — |           — |           — |
| WATER_MISSED |           — |           — |      +7,160 |      +7,755 |      +7,160 |      +7,239 |
| FEED_MISSED |           — |      +7,169 |      +5,081 |           — |           — |      +6,630 |
...
|---|---|---:|---:|---:|---:|
| 1 | HIRE | late | +7,463 | 2049 | 1.66 |
| 2 | BUY_SEED | early | +7,368 | 9363 | 1.66 |
| 3 | WATER_MISSED | early | +7,354 | 10010 | 1.67 |
| 4 | BUY_LAND | early | +7,265 | 3118 | 1.59 |
| 5 | HIRE | mid | +7,247 | 3029 | 1.56 |
| 6 | SELL | early | +7,205 | 11419 | 1.6 |
| 7 | BUY_SEED | mid | +7,187 | 3131 | 1.53 |
| 8 | BUY_PRODUCT | late | +7,178 | 5830 | 1.57 |
| 9 | WATER_MISSED | late | +7,172 | 6707 | 1.57 |
| 10 | HIRE | early | +7,161 | 6377 | 1.56 |
...
- **FEED_MISSED** in ('mid', 'low', 'mid', 'high'): +9,561 (n=122)
- **BUY_LAND** in ('mid', 'low', 'mid', 'high'): +9,531 (n=126)
- **BUY_ANIMAL** in ('mid', 'low', 'mid', 'high'): +9,472 (n=127)
- **WATER_MISSED** in ('mid', 'low', 'mid', 'high'): +9,420 (n=128)
- **SELL** in ('mid', 'low', 'mid', 'high'): +9,407 (n=129)
- **BUY_SEED** in ('mid', 'low', 'mid', 'high'): +9,407 (n=129)
- **BUY_PRODUCT** in ('mid', 'low', 'mid', 'high'): +9,407 (n=129)
- **HIRE** in ('low', 'low', 'low', 'mid'): +9,044 (n=5)
- **BUY_SEED** in ('low', 'low', 'low', 'mid'): +8,844 (n=39)
- **WATER_MISSED** in ('low', 'low', 'low', 'mid'): +8,573 (n=113)
- **WATER_MISSED** in ('low', 'mid', 'high', 'high'): +8,562 (n=524)
- **BUY_SEED** in ('low', 'mid', 'high', 'high'): +8,560 (n=470)
- **SELL** in ('low', 'low', 'low', 'mid'): +8,538 (n=121)
- **BUY_PRODUCT** in ('low', 'low', 'low', 'mid'): +8,538 (n=121)
- **BUY_ANIMAL** in ('low', 'low', 'low', 'mid'): +8,505 (n=120)
