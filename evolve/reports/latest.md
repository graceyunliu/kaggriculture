...
Elapsed 0.04 h · candidates evaluated this run: 2 · games 778 (17,863/h)
...
Population (all runs, reached dev): 1554 · held-out evaluated: 908 · held-out PASS: 894
...
|---|---:|---|---|---:|---:|---:|---|
| ROUTE_LEN | +17,633 | 2 | 3 | 4 | 1554 | 1.85 | 2: +9,385 (n=1108), 3: +5,206 (n=422), 4: +615 (n=21), 5: -8,248 (n=3) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| MAX_HANDS | +15,799 | 16 | 14 | 8 | 1554 | 1.92 | 16: +9,395 (n=567), 15: +8,706 (n=487), 13: +7,937 (n=46), 12: +7,140 (n=23), 14: +5,879 (n=420), 11: +4,721 (n=7), 10: -616 (n=2), 8: -6,404 (n=2) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| MELON_PRICE_CUSHION | +13,911 | 81 | 100 | 63 | 1537 | 23.63 | 81: +13,020 (n=2), 53: +12,736 (n=3), 73: +12,491 (n=2), 50: +11,794 (n=5), 119: +11,101 (n=7), 60: +11,063 (n=4), 80: +10,776 (n=8), 86: +10,542 (n=8), 112: +10,371 (n=40), 103: +10,282 (n=4), 117: +10,236 (n=5), 127: +10,227 (n=18), 54: +10,157 (n=2), 133: +10,154 (n=2), 146: +10,055 (n=3), 82: +9,924 (n=225), 63: +9,835 (n=2), 101: +9,491 (n=15), 99: +8,609 (n=11), 88: +8,576 (n=2), 96: +8,485 (n=3), 120: +8,376 (n=21), 68: +8,143 (n=29), 100: +7,985 (n=823), 94: +7,681 (n=5), 111: +7,630 (n=11), 106: +7,054 (n=10), 107: +6,708 (n=139), 148: +6,535 (n=2), 114: +6,129 (n=2), 131: +6,008 (n=4), 116: +5,946 (n=66), 84: +5,799 (n=4), 93: +5,643 (n=6), 128: +5,640 (n=11), 143: +3,933 (n=3), 150: +3,570 (n=4), 136: +3,537 (n=3), 87: +3,081 (n=2), 90: +2,614 (n=2), 92: +2,237 (n=4), 85: +1,681 (n=2), 76: +1,491 (n=2), 77: +1,272 (n=2), 134: +712 (n=7), 118: -891 (n=2) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| wheat_stock | +12,264 | 3 | 0 | 27 | 1546 | 12.48 | 3: +9,768 (n=13), 13: +9,459 (n=4), 2: +9,016 (n=6), 5: +9,014 (n=52), 4: +8,779 (n=7), 9: +8,563 (n=8), 0: +8,461 (n=1097), 17: +7,175 (n=5), 7: +7,048 (n=7), 1: +6,991 (n=312), 10: +6,704 (n=15), 6: +5,817 (n=2), 8: +5,801 (n=4), 12: +5,266 (n=4), 11: +3,818 (n=2), 25: +1,654 (n=2), 40: +930 (n=2), 14: +563 (n=2), 22: -2,496 (n=2) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| max_animals | +11,031 | 16 | 17 | 11 | 1553 | 5.05 | 16: +9,971 (n=341), 15: +9,755 (n=142), 14: +7,744 (n=21), 17: +7,697 (n=939), 19: +6,601 (n=10), 13: +5,004 (n=5), 18: +3,969 (n=62), 20: +2,810 (n=24), 10: +1,562 (n=3), 12: -1,060 (n=6) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| wheat_sell_price | +10,858 | 33 | 30 | 21 | 1553 | 7.78 | 33: +10,969 (n=4), 37: +10,903 (n=2), 31: +9,321 (n=8), 29: +9,165 (n=682), 39: +9,053 (n=2), 28: +8,889 (n=15), 38: +8,824 (n=4), 25: +8,580 (n=359), 32: +8,344 (n=8), 26: +7,917 (n=104), 27: +7,510 (n=15), 36: +6,988 (n=6), 42: +6,603 (n=18), 34: +6,461 (n=16), 30: +5,485 (n=283), 35: +4,663 (n=14), 44: +3,195 (n=2), 43: +3,122 (n=6), 40: +2,392 (n=3), 41: +110 (n=2) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| wheat_cap | +10,389 | 23 | 22 | 18 | 1551 | 5.5 | 23: +10,705 (n=9), 17: +10,409 (n=10), 14: +9,834 (n=39), 20: +9,756 (n=474), 11: +8,057 (n=18), 24: +7,990 (n=5), 21: +7,565 (n=672), 25: +7,251 (n=58), 19: +7,115 (n=8), 13: +7,078 (n=3), 22: +6,758 (n=172), 5: +6,324 (n=7), 16: +6,028 (n=4), 18: +5,898 (n=62), 15: +315 (n=10) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| open_melons | +9,876 | 7 | 10 | 11 | 1554 | 7.43 | 7: +9,184 (n=17), 11: +8,968 (n=48), 10: +8,430 (n=74), 6: +8,402 (n=66), 9: +8,239 (n=1191), 8: +7,286 (n=102), 12: +6,931 (n=16), 5: +6,249 (n=8), 4: +3,991 (n=25), 13: +3,083 (n=2), 14: -692 (n=5) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| opening | +9,360 | frontier | frontier | 2 | 1554 | 0.79 | frontier: +9,098 (n=1388), v312: -263 (n=166) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| wheat_per_animal | +9,313 | 0.0 | 0.0 | 9 | 1553 | 6.48 | 0.0: +8,272 (n=1452), 0.3: +6,955 (n=17), 0.2: +6,431 (n=41), 0.1: +5,367 (n=21), 0.4: +5,261 (n=8), 0.6: +4,309 (n=4), 0.5: +2,999 (n=8), 0.7: -1,041 (n=2) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| open_sheep | +9,156 | 2 | 2 | 4 | 1554 | 2.75 | 2: +8,315 (n=1457), 1: +6,059 (n=67), 0: +3,593 (n=20), 3: -841 (n=10) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| demand_share | +9,103 | 0.6 | 0.55 | 14 | 1554 | 9.86 | 0.6: +8,552 (n=37), 0.55: +8,549 (n=1206), 0.45: +7,997 (n=29), 0.4: +7,603 (n=11), 0.5: +7,547 (n=120), 0.65: +7,102 (n=26), 0.75: +7,015 (n=11), 0.85: +6,133 (n=4), 0.35: +5,397 (n=12), 0.9: +4,856 (n=5), 0.8: +4,341 (n=25), 0.7: +4,281 (n=42), 0.3: +3,093 (n=24), 1.0: -551 (n=2) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| MELON_MORNING_LAST_HOUR | +8,892 | 9 | 8 | 9 | 1554 | 3.78 | 9: +9,483 (n=826), 10: +8,909 (n=39), 5: +8,778 (n=6), 11: +7,626 (n=21), 7: +7,109 (n=15), 8: +6,844 (n=536), 4: +5,562 (n=30), 12: +3,234 (n=76), 6: +591 (n=5) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| OPP_GROWTH | +8,360 | 1.1 | 1.4 | 9 | 1554 | 2.24 | 1.1: +9,836 (n=559), 1.5: +8,616 (n=159), 1.2: +7,752 (n=109), 1.3: +7,058 (n=501), 1.8: +6,509 (n=12), 1.4: +6,479 (n=145), 1.0: +5,991 (n=37), 1.6: +5,503 (n=12), 1.7: +1,476 (n=20) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| load_per_hand | +7,834 | 21 | 20 | 15 | 1554 | 7.36 | 21: +10,141 (n=43), 19: +9,681 (n=366), 20: +7,987 (n=866), 16: +7,619 (n=25), 25: +7,430 (n=3), 22: +7,405 (n=22), 17: +7,395 (n=85), 18: +7,305 (n=50), 14: +6,635 (n=11), 24: +5,475 (n=6), 23: +4,719 (n=11), 26: +3,301 (n=4), 13: +3,027 (n=3), 15: +2,348 (n=52), 12: +2,307 (n=7) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| MAX_SHEEP | +7,594 | 13 | 14 | 10 | 1551 | 3.89 | 13: +9,425 (n=391), 14: +7,921 (n=1083), 12: +7,487 (n=19), 11: +6,305 (n=9), 8: +6,166 (n=3), 9: +3,009 (n=23), 10: +1,832 (n=23) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| STRAW_CUTOFF | +7,081 | 16 | 19 | 8 | 1553 | 4.6 | 16: +9,751 (n=67), 17: +8,295 (n=24), 19: +8,105 (n=1243), 20: +7,621 (n=189), 18: +7,514 (n=25), 14: +5,891 (n=2), 15: +2,670 (n=3) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| HERD_LAST_DAY | +6,495 | 18 | 17 | 8 | 1552 | 2.27 | 18: +9,198 (n=23), 20: +9,092 (n=846), 16: +8,738 (n=2), 17: +6,825 (n=677), 21: +5,275 (n=2), 19: +2,703 (n=2) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| OPENING_MELONS | +6,293 | 10 | 14 | 8 | 1553 | 2.98 | 10: +10,622 (n=6), 11: +9,793 (n=173), 13: +9,632 (n=443), 8: +8,647 (n=6), 12: +7,693 (n=38), 14: +7,026 (n=882), 9: +4,329 (n=5) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| CROP_SWEEP_LEN | +6,047 | 8 | 6 | 8 | 1554 | 3.56 | 8: +8,874 (n=886), 10: +8,032 (n=61), 7: +7,898 (n=78), 5: +7,589 (n=32), 6: +7,061 (n=379), 9: +6,895 (n=61), 3: +5,512 (n=43), 4: +2,826 (n=14) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
...
_Generated 2026-09-15 21:27. Candidate files in `evolve/gen/`, DB `evolve/evolve.db`._
...
**1554 candidates** with action_table data, **212623 total action events** extracted (SELL/BUY item counts are averaged across the 5 trajectory seeds — see trace.py SUMMARY_FIELDS).

Action timing vs outcome correlation. For each action type, the table shows mean dev_margin of candidates that performed that action in each horizon bucket. Higher dev_margin = better outcome. This is NOT causal — a candidate that sells early may also have other good properties. Use as a guide for what to test, not as a proven mechanism.

| action_type | early (days 1-14) | mid (days 15-21) | late (days 22-29) | total events |
|---|---|---:|---|---|---:|
| SELL |         +8,143 (n=20985) |         +8,098 (n=10878) |         +8,098 (n=12432) | 44295 |
| BUY_ANIMAL |         +7,740 (n=10315) |         +7,818 (n=2423) |              — (n=0) | 12738 |
| BUY_SEED |         +8,321 (n=17290) |         +8,102 (n=5734) |         +7,867 (n=2323) | 25347 |
| BUY_LAND |         +8,277 (n=5863) |         +7,951 (n=1142) |              — (n=0) | 7005 |
| BUY_PRODUCT |         +8,098 (n=23285) |         +8,098 (n=10878) |         +8,131 (n=10633) | 44796 |
| HIRE |         +8,139 (n=11746) |         +8,163 (n=5697) |         +8,480 (n=3909) | 21352 |
| WATER_MISSED |         +8,259 (n=18355) |         +8,098 (n=10878) |         +8,105 (n=12301) | 41534 |
  _Water missed = postponement signal. Negative = candidates that missed water had lower dev_margin._
| FEED_MISSED |         +7,871 (n=9379) |         +6,899 (n=2771) |         +7,498 (n=3406) | 15556 |
...
|---|---|---:|---:|---:|---:|---:|---:|
| SELL |      +8,226 |      +8,107 |      +7,742 |      +8,656 |      +7,964 |      +8,078 |
| BUY_ANIMAL |      +7,204 |           — |           — |         -35 |      +9,098 |      +7,667 |
| BUY_SEED |      +8,050 |      +8,593 |      +4,264 |      +2,156 |      +9,319 |      +8,182 |
| BUY_LAND |           — |      +2,957 |      +8,148 |      +1,344 |      +8,731 |      +8,280 |
| BUY_PRODUCT |      +8,106 |           — |           — |           — |           — |           — |
| HIRE |      +8,208 |           — |           — |           — |           — |           — |
| WATER_MISSED |           — |           — |      +8,098 |      +8,578 |      +8,098 |      +8,163 |
| FEED_MISSED |           — |      +8,111 |      +5,474 |           — |           — |      +7,582 |
...
|---|---|---:|---:|---:|---:|
| 1 | HIRE | late | +8,480 | 3909 | 1.83 |
| 2 | BUY_SEED | early | +8,321 | 17290 | 1.79 |
| 3 | BUY_LAND | early | +8,277 | 5863 | 1.74 |
| 4 | WATER_MISSED | early | +8,259 | 18355 | 1.79 |
| 5 | HIRE | mid | +8,163 | 5697 | 1.7 |
| 6 | SELL | early | +8,143 | 20985 | 1.73 |
| 7 | HIRE | early | +8,139 | 11746 | 1.71 |
| 8 | BUY_PRODUCT | late | +8,131 | 10633 | 1.71 |
| 9 | WATER_MISSED | late | +8,105 | 12301 | 1.7 |
| 10 | BUY_SEED | mid | +8,102 | 5734 | 1.68 |
...
- **BUY_LAND** in ('mid', 'mid', 'mid', 'high'): +9,380 (n=993)
- **FEED_MISSED** in ('low', 'low', 'low', 'high'): +9,280 (n=2129)
