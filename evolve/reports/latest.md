...
Elapsed 0.02 h · candidates evaluated this run: 0 · games 448 (19,558/h)
...
Population (all runs, reached dev): 2038 · held-out evaluated: 908 · held-out PASS: 894
...
- best: best +15,151 (`51435ac9641b`), n=730
...
|---|---:|---|---|---:|---:|---:|---|
| max_animals | +15,937 | 16 | 17 | 11 | 2038 | 4.8 | 16: +9,646 (n=385), 15: +8,058 (n=215), 17: +6,920 (n=1075), 18: +3,657 (n=65), 19: +3,159 (n=28), 20: +2,614 (n=26), 14: +659 (n=145), 13: -66 (n=16), 12: -4,042 (n=72), 10: -4,731 (n=8), 11: -6,291 (n=3) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| ROUTE_LEN | +15,266 | 2 | 3 | 4 | 2038 | 2.06 | 2: +7,018 (n=1559), 3: +4,702 (n=450), 4: -218 (n=26), 5: -8,248 (n=3) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| MELON_PRICE_CUSHION | +14,993 | 81 | 100 | 75 | 2021 | 25.89 | 81: +13,020 (n=2), 53: +12,736 (n=3), 73: +12,491 (n=2), 60: +11,063 (n=4), 86: +10,542 (n=8), 112: +10,355 (n=53), 54: +10,157 (n=2), 146: +10,055 (n=3), 119: +9,950 (n=8), 82: +9,845 (n=247), 63: +9,835 (n=2), 50: +9,759 (n=8), 103: +9,744 (n=6), 127: +9,392 (n=21), 99: +8,609 (n=11), 96: +8,485 (n=3), 68: +8,143 (n=29), 80: +8,105 (n=14), 94: +7,681 (n=5), 100: +7,138 (n=937), 106: +7,054 (n=10), 120: +6,885 (n=27), 148: +6,535 (n=2), 87: +6,450 (n=3), 114: +6,129 (n=2), 116: +5,946 (n=66), 84: +5,799 (n=4), 93: +5,643 (n=6), 128: +5,640 (n=11), 105: +5,364 (n=3), 101: +5,265 (n=21), 88: +4,625 (n=3), 143: +3,933 (n=3), 131: +3,889 (n=5), 136: +3,537 (n=3), 125: +3,420 (n=4), 117: +2,970 (n=26), 121: +2,851 (n=2), 107: +2,849 (n=295), 108: +2,827 (n=3), 92: +2,237 (n=4), 58: +2,196 (n=8), 150: +1,841 (n=6), 85: +1,681 (n=2), 111: +1,665 (n=28), 66: +1,516 (n=2), 77: +1,272 (n=2), 134: +712 (n=7), 133: +586 (n=7), 113: +446 (n=37), 90: +440 (n=3), 76: +408 (n=5), 118: +247 (n=9), 89: -147 (n=2), 83: -215 (n=9), 102: -665 (n=2), 110: -900 (n=19), 137: -1,973 (n=2) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| MAX_HANDS | +13,837 | 15 | 14 | 8 | 2038 | 1.98 | 15: +7,433 (n=604), 16: +7,146 (n=760), 13: +5,199 (n=81), 14: +4,711 (n=528), 11: +3,923 (n=9), 12: +3,546 (n=51), 10: -1,909 (n=3), 8: -6,404 (n=2) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| MAX_SHEEP | +13,275 | 13 | 14 | 10 | 2036 | 4.92 | 13: +9,216 (n=415), 14: +5,973 (n=1506), 12: +5,628 (n=25), 8: +4,024 (n=4), 9: +1,572 (n=30), 10: +751 (n=28), 11: +172 (n=25), 4: -4,059 (n=3) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| ORCH_SLACK_HOUR | +12,610 | 12 | 14 | 4 | 489 | 2.18 | 12: +10,878 (n=17), 15: +7,379 (n=81), 14: +5,133 (n=389), 8: -1,732 (n=2) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| wheat_stock | +12,264 | 3 | 0 | 28 | 2029 | 13.69 | 3: +9,768 (n=13), 5: +8,908 (n=54), 4: +8,779 (n=7), 9: +8,563 (n=8), 2: +7,341 (n=8), 17: +7,175 (n=5), 1: +7,062 (n=316), 7: +7,048 (n=7), 10: +6,704 (n=15), 0: +6,151 (n=1569), 6: +5,817 (n=2), 8: +5,801 (n=4), 13: +5,607 (n=6), 12: +4,275 (n=5), 11: +3,818 (n=2), 25: +1,654 (n=2), 40: +930 (n=2), 14: +563 (n=2), 22: -2,496 (n=2) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| MELON_MORNING_LAST_HOUR | +11,262 | 9 | 8 | 9 | 2038 | 3.24 | 9: +8,917 (n=959), 5: +7,230 (n=8), 11: +7,125 (n=22), 10: +4,736 (n=82), 8: +4,625 (n=734), 4: +4,490 (n=52), 12: +1,693 (n=108), 7: +1,221 (n=65), 6: -2,345 (n=8) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| wheat_sell_price | +10,792 | 37 | 30 | 21 | 2037 | 6.69 | 37: +10,903 (n=2), 29: +8,691 (n=783), 25: +8,237 (n=395), 27: +7,664 (n=18), 26: +6,828 (n=123), 42: +6,603 (n=18), 31: +5,392 (n=13), 33: +4,912 (n=9), 34: +4,621 (n=25), 39: +4,307 (n=3), 36: +3,865 (n=8), 35: +3,401 (n=17), 44: +3,195 (n=2), 43: +3,122 (n=6), 30: +2,540 (n=526), 40: +2,251 (n=4), 28: +2,154 (n=42), 38: +1,922 (n=10), 32: +898 (n=31), 41: +110 (n=2) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| load_per_hand | +10,332 | 19 | 20 | 15 | 2038 | 7.71 | 19: +9,402 (n=406), 21: +8,265 (n=60), 17: +7,375 (n=87), 16: +6,975 (n=29), 14: +6,635 (n=11), 18: +6,201 (n=59), 20: +5,944 (n=1183), 23: +4,417 (n=14), 24: +3,812 (n=8), 22: +2,831 (n=90), 25: +1,253 (n=6), 15: +854 (n=64), 13: -83 (n=5), 26: -177 (n=6), 12: -931 (n=10) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| early_hire_days | +9,580 | 8 | 3 | 9 | 2038 | 2.56 | 8: +9,618 (n=807), 6: +7,323 (n=30), 7: +6,858 (n=22), 5: +6,506 (n=669), 2: +4,702 (n=82), 4: +2,253 (n=40), 0: +2,208 (n=18), 1: +1,451 (n=8), 3: +38 (n=362) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| open_melons | +9,360 | 9 | 10 | 11 | 2038 | 6.15 | 9: +7,938 (n=1324), 6: +6,932 (n=78), 7: +6,879 (n=23), 8: +6,349 (n=120), 5: +6,249 (n=8), 11: +6,135 (n=66), 12: +5,062 (n=20), 4: +3,991 (n=25), 10: +1,118 (n=363), 13: +1,000 (n=4), 14: -1,422 (n=7) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| OPENING_MELONS | +9,164 | 10 | 14 | 9 | 2037 | 3.89 | 10: +10,817 (n=8), 11: +9,695 (n=182), 13: +9,380 (n=519), 8: +8,647 (n=6), 12: +5,100 (n=64), 14: +4,739 (n=1244), 9: +4,329 (n=5), 7: +1,653 (n=9) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| OPP_GROWTH | +9,123 | 1.1 | 1.4 | 9 | 2038 | 1.81 | 1.1: +9,659 (n=626), 1.5: +8,068 (n=171), 1.3: +5,516 (n=636), 1.2: +5,173 (n=160), 1.6: +4,787 (n=15), 1.0: +3,310 (n=85), 1.4: +3,071 (n=279), 1.7: +1,476 (n=20), 1.8: +537 (n=46) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| opening | +9,042 | frontier | frontier | 2 | 2038 | 0.78 | frontier: +7,394 (n=1812), v312: -1,647 (n=226) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| wheat_cap | +8,937 | 14 | 22 | 18 | 2035 | 4.07 | 14: +9,904 (n=41), 20: +9,629 (n=536), 17: +9,101 (n=13), 11: +8,240 (n=19), 21: +7,478 (n=688), 13: +5,940 (n=4), 18: +5,639 (n=67), 19: +5,513 (n=10), 5: +4,810 (n=8), 24: +3,821 (n=14), 23: +2,582 (n=41), 25: +2,501 (n=175), 22: +2,284 (n=400), 15: +1,557 (n=11), 16: +968 (n=8) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| harvest_min | +8,828 | 2 | 1 | 3 | 489 | 1.76 | 2: +8,223 (n=18), 1: +5,868 (n=450), 3: -605 (n=21) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| wheat_per_animal | +8,372 | 0.0 | 0.0 | 11 | 2035 | 6.25 | 0.0: +6,773 (n=1843), 0.3: +6,485 (n=21), 0.2: +5,724 (n=46), 0.1: +2,452 (n=53), 0.4: +2,411 (n=24), 0.5: +1,920 (n=10), 0.6: -1,206 (n=20), 0.7: -1,599 (n=18) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| fert_carry | +7,990 | 2 | 2 | 3 | 488 | 0.99 | 2: +5,699 (n=486), 1: -2,291 (n=2) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| open_sheep | +7,950 | 2 | 2 | 4 | 2038 | 2.69 | 2: +6,718 (n=1881), 1: +3,507 (n=104), 0: +2,484 (n=24), 3: -1,231 (n=29) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
...
_Generated 2026-09-16 09:26. Candidate files in `evolve/gen/`, DB `evolve/evolve.db`._
...
**2038 candidates** with action_table data, **277472 total action events** extracted (SELL/BUY item counts are averaged across the 5 trajectory seeds — see trace.py SUMMARY_FIELDS).

Action timing vs outcome correlation. For each action type, the table shows mean dev_margin of candidates that performed that action in each horizon bucket. Higher dev_margin = better outcome. This is NOT causal — a candidate that sells early may also have other good properties. Use as a guide for what to test, not as a proven mechanism.

| action_type | early (days 1-14) | mid (days 15-21) | late (days 22-29) | total events |
|---|---|---:|---|---|---:|
| SELL |         +6,438 (n=27514) |         +6,392 (n=14266) |         +6,392 (n=16304) | 58084 |
| BUY_ANIMAL |         +6,077 (n=13504) |         +6,316 (n=3072) |              — (n=0) | 16576 |
| BUY_SEED |         +6,753 (n=22219) |         +6,272 (n=7636) |         +5,955 (n=3123) | 32978 |
| BUY_LAND |         +6,583 (n=7663) |         +5,773 (n=1589) |              — (n=0) | 9252 |
| BUY_PRODUCT |         +6,395 (n=30526) |         +6,392 (n=14266) |         +6,429 (n=13922) | 58714 |
| HIRE |         +6,537 (n=15175) |         +6,404 (n=7549) |         +7,030 (n=4972) | 27696 |
| WATER_MISSED |         +6,662 (n=23703) |         +6,392 (n=14266) |         +6,399 (n=16128) | 54097 |
  _Water missed = postponement signal. Negative = candidates that missed water had lower dev_margin._
| FEED_MISSED |         +6,244 (n=12237) |         +5,635 (n=3445) |         +5,989 (n=4393) | 20075 |
...
|---|---|---:|---:|---:|---:|---:|---:|
| SELL |      +6,518 |      +6,395 |      +6,069 |      +7,378 |      +6,350 |      +6,325 |
| BUY_ANIMAL |      +5,527 |           — |           — |         -35 |      +7,394 |      +6,052 |
| BUY_SEED |      +6,648 |      +6,950 |      +3,244 |      +1,414 |      +7,496 |      +6,483 |
| BUY_LAND |           — |      +3,080 |      +6,493 |      -1,943 |      +7,498 |      +6,440 |
| BUY_PRODUCT |      +6,402 |           — |           — |           — |           — |           — |
| HIRE |      +6,589 |           — |           — |           — |           — |           — |
| WATER_MISSED |           — |           — |      +6,392 |      +7,756 |      +6,392 |      +6,482 |
| FEED_MISSED |           — |      +6,410 |      +4,619 |           — |           — |      +6,060 |
...
|---|---|---:|---:|---:|---:|
| 1 | HIRE | late | +7,030 | 4972 | 1.24 |
| 2 | BUY_SEED | early | +6,753 | 22219 | 1.18 |
| 3 | WATER_MISSED | early | +6,662 | 23703 | 1.17 |
| 4 | BUY_LAND | early | +6,583 | 7663 | 1.12 |
| 5 | HIRE | early | +6,537 | 15175 | 1.12 |
| 6 | SELL | early | +6,438 | 27514 | 1.1 |
| 7 | BUY_PRODUCT | late | +6,429 | 13922 | 1.1 |
| 8 | HIRE | mid | +6,404 | 7549 | 1.08 |
| 9 | WATER_MISSED | late | +6,399 | 16128 | 1.09 |
| 10 | BUY_PRODUCT | early | +6,395 | 30526 | 1.09 |
...
- **BUY_LAND** in ('mid', 'mid', 'mid', 'high'): +8,189 (n=1222)
- **BUY_SEED** in ('low', 'mid', 'high', 'high'): +7,840 (n=1296)
- **WATER_MISSED** in ('mid', 'low', 'mid', 'high'): +7,740 (n=223)
- **SELL** in ('low', 'low', 'mid', 'mid'): +7,632 (n=1593)
- **FEED_MISSED** in ('low', 'low', 'low', 'high'): +7,450 (n=2793)
- **BUY_LAND** in ('mid', 'low', 'mid', 'high'): +7,415 (n=233)
- **FEED_MISSED** in ('mid', 'mid', 'mid', 'high'): +7,401 (n=1397)
