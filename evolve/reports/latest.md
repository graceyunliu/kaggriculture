...
Elapsed 0.03 h · candidates evaluated this run: 0 · games 608 (18,213/h)
...
Population (all runs, reached dev): 1616 · held-out evaluated: 908 · held-out PASS: 894
...
- best: best +15,151 (`51435ac9641b`), n=603
...
|---|---:|---|---|---:|---:|---:|---|
| ROUTE_LEN | +17,651 | 2 | 3 | 4 | 1616 | 1.89 | 2: +9,403 (n=1166), 3: +5,184 (n=424), 4: +684 (n=23), 5: -8,248 (n=3) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| MAX_HANDS | +15,821 | 16 | 14 | 8 | 1616 | 2.0 | 16: +9,416 (n=605), 15: +8,679 (n=504), 13: +7,893 (n=48), 12: +7,140 (n=23), 14: +5,929 (n=425), 11: +4,721 (n=7), 10: -616 (n=2), 8: -6,404 (n=2) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| MELON_PRICE_CUSHION | +12,308 | 81 | 100 | 65 | 1597 | 22.94 | 81: +13,020 (n=2), 53: +12,736 (n=3), 73: +12,491 (n=2), 119: +11,101 (n=7), 103: +11,085 (n=5), 60: +11,063 (n=4), 50: +10,875 (n=6), 86: +10,542 (n=8), 112: +10,355 (n=53), 117: +10,236 (n=5), 54: +10,157 (n=2), 133: +10,154 (n=2), 146: +10,055 (n=3), 127: +9,869 (n=20), 63: +9,835 (n=2), 82: +9,805 (n=240), 101: +9,491 (n=15), 80: +9,159 (n=13), 99: +8,609 (n=11), 88: +8,576 (n=2), 120: +8,564 (n=22), 96: +8,485 (n=3), 68: +8,143 (n=29), 100: +7,989 (n=831), 94: +7,681 (n=5), 111: +7,630 (n=11), 106: +7,054 (n=10), 107: +7,003 (n=152), 148: +6,535 (n=2), 114: +6,129 (n=2), 131: +6,008 (n=4), 116: +5,946 (n=66), 84: +5,799 (n=4), 93: +5,643 (n=6), 128: +5,640 (n=11), 143: +3,933 (n=3), 118: +3,604 (n=3), 150: +3,570 (n=4), 136: +3,537 (n=3), 87: +3,081 (n=2), 90: +2,614 (n=2), 92: +2,237 (n=4), 85: +1,681 (n=2), 76: +1,491 (n=2), 77: +1,272 (n=2), 134: +712 (n=7) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| wheat_stock | +12,264 | 3 | 0 | 27 | 1608 | 12.64 | 3: +9,768 (n=13), 13: +9,459 (n=4), 5: +9,086 (n=53), 2: +9,016 (n=6), 4: +8,779 (n=7), 9: +8,563 (n=8), 0: +8,481 (n=1154), 17: +7,175 (n=5), 1: +7,062 (n=316), 7: +7,048 (n=7), 10: +6,704 (n=15), 6: +5,817 (n=2), 8: +5,801 (n=4), 12: +5,266 (n=4), 11: +3,818 (n=2), 25: +1,654 (n=2), 40: +930 (n=2), 14: +563 (n=2), 22: -2,496 (n=2) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| max_animals | +10,999 | 16 | 17 | 11 | 1615 | 4.9 | 16: +9,939 (n=365), 15: +9,810 (n=164), 14: +7,744 (n=21), 17: +7,711 (n=953), 19: +6,601 (n=10), 18: +3,890 (n=63), 13: +3,703 (n=6), 20: +2,810 (n=24), 10: +1,562 (n=3), 12: -1,060 (n=6) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| wheat_sell_price | +10,858 | 33 | 30 | 21 | 1615 | 7.98 | 33: +10,969 (n=4), 37: +10,903 (n=2), 31: +9,321 (n=8), 29: +9,159 (n=725), 39: +9,053 (n=2), 28: +8,889 (n=15), 38: +8,824 (n=4), 25: +8,633 (n=373), 32: +8,344 (n=8), 26: +7,917 (n=104), 27: +7,664 (n=18), 36: +6,988 (n=6), 42: +6,603 (n=18), 34: +6,461 (n=16), 30: +5,496 (n=285), 35: +4,663 (n=14), 44: +3,195 (n=2), 43: +3,122 (n=6), 40: +2,392 (n=3), 41: +110 (n=2) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| open_melons | +10,227 | 7 | 10 | 11 | 1616 | 7.49 | 7: +9,535 (n=19), 11: +8,912 (n=50), 10: +8,430 (n=74), 6: +8,419 (n=67), 9: +8,284 (n=1247), 8: +7,286 (n=102), 12: +6,931 (n=16), 5: +6,249 (n=8), 4: +3,991 (n=25), 13: +2,857 (n=3), 14: -692 (n=5) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| wheat_cap | +9,702 | 17 | 22 | 18 | 1613 | 5.3 | 17: +10,018 (n=12), 23: +9,971 (n=11), 14: +9,946 (n=40), 20: +9,733 (n=519), 11: +8,240 (n=19), 21: +7,568 (n=677), 25: +7,368 (n=59), 19: +7,115 (n=8), 22: +6,831 (n=174), 5: +6,324 (n=7), 16: +6,028 (n=4), 18: +5,987 (n=63), 13: +5,940 (n=4), 24: +5,470 (n=6), 15: +315 (n=10) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| opening | +9,411 | frontier | frontier | 2 | 1616 | 0.78 | frontier: +9,153 (n=1442), v312: -259 (n=174) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| wheat_per_animal | +9,347 | 0.0 | 0.0 | 9 | 1615 | 6.49 | 0.0: +8,306 (n=1513), 0.3: +7,294 (n=18), 0.2: +6,431 (n=41), 0.1: +5,367 (n=21), 0.4: +5,261 (n=8), 0.6: +4,309 (n=4), 0.5: +2,999 (n=8), 0.7: -1,041 (n=2) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| demand_share | +9,164 | 0.55 | 0.55 | 14 | 1616 | 9.87 | 0.55: +8,613 (n=1255), 0.6: +8,471 (n=39), 0.45: +7,670 (n=30), 0.4: +7,603 (n=11), 0.5: +7,494 (n=121), 0.75: +7,389 (n=12), 0.65: +7,304 (n=27), 0.85: +5,351 (n=5), 0.9: +4,856 (n=5), 0.8: +4,568 (n=26), 0.7: +4,446 (n=45), 0.35: +4,433 (n=13), 0.3: +3,220 (n=25), 1.0: -551 (n=2) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| open_sheep | +8,926 | 2 | 2 | 4 | 1616 | 2.75 | 2: +8,363 (n=1516), 1: +6,007 (n=68), 0: +3,434 (n=21), 3: -563 (n=11) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| MELON_MORNING_LAST_HOUR | +8,883 | 9 | 8 | 9 | 1616 | 3.9 | 9: +9,474 (n=880), 10: +8,842 (n=41), 5: +8,778 (n=6), 11: +7,626 (n=21), 7: +7,109 (n=15), 8: +6,829 (n=537), 4: +6,221 (n=35), 12: +3,234 (n=76), 6: +591 (n=5) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| OPP_GROWTH | +8,293 | 1.1 | 1.4 | 9 | 1616 | 2.36 | 1.1: +9,769 (n=604), 1.5: +8,570 (n=161), 1.2: +7,794 (n=110), 1.3: +7,115 (n=510), 1.4: +6,528 (n=148), 1.8: +6,509 (n=12), 1.0: +6,161 (n=38), 1.6: +6,101 (n=13), 1.7: +1,476 (n=20) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| load_per_hand | +8,000 | 21 | 20 | 15 | 1616 | 7.36 | 21: +10,307 (n=45), 19: +9,635 (n=386), 20: +8,041 (n=901), 16: +7,549 (n=27), 17: +7,468 (n=86), 25: +7,430 (n=3), 22: +7,405 (n=22), 18: +7,128 (n=51), 14: +6,635 (n=11), 24: +5,475 (n=6), 23: +5,355 (n=12), 26: +3,301 (n=4), 13: +3,027 (n=3), 15: +2,348 (n=52), 12: +2,307 (n=7) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| MAX_SHEEP | +7,637 | 13 | 14 | 10 | 1613 | 3.91 | 13: +9,468 (n=403), 14: +7,955 (n=1132), 12: +7,688 (n=20), 11: +6,305 (n=9), 8: +6,166 (n=3), 9: +3,009 (n=23), 10: +1,832 (n=23) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| STRAW_CUTOFF | +7,272 | 16 | 19 | 8 | 1615 | 4.56 | 16: +9,942 (n=73), 17: +8,295 (n=24), 19: +8,124 (n=1282), 20: +7,750 (n=206), 18: +7,514 (n=25), 14: +5,891 (n=2), 15: +2,670 (n=3) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| HERD_LAST_DAY | +6,495 | 18 | 17 | 8 | 1615 | 2.83 | 18: +9,198 (n=23), 20: +9,089 (n=884), 22: +8,949 (n=7), 16: +8,738 (n=2), 17: +6,904 (n=695), 21: +5,275 (n=2), 19: +2,703 (n=2) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| OPENING_MELONS | +6,488 | 10 | 14 | 8 | 1615 | 2.84 | 10: +10,817 (n=8), 11: +9,718 (n=177), 13: +9,621 (n=492), 8: +8,647 (n=6), 12: +7,624 (n=40), 14: +7,033 (n=887), 9: +4,329 (n=5) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
| CROP_SWEEP_LEN | +6,018 | 8 | 6 | 8 | 1616 | 3.53 | 8: +8,844 (n=915), 7: +8,139 (n=84), 10: +8,070 (n=65), 5: +7,685 (n=33), 6: +7,249 (n=400), 9: +6,820 (n=62), 3: +5,512 (n=43), 4: +2,826 (n=14) |
  __Observed outcome variation, NOT causal importance. Confounded by interactions, seed variance, selection bias, and outliers. Treat as exploration weight only.__
...
_Generated 2026-09-16 00:47. Candidate files in `evolve/gen/`, DB `evolve/evolve.db`._
...
**1616 candidates** with action_table data, **221110 total action events** extracted (SELL/BUY item counts are averaged across the 5 trajectory seeds — see trace.py SUMMARY_FIELDS).

Action timing vs outcome correlation. For each action type, the table shows mean dev_margin of candidates that performed that action in each horizon bucket. Higher dev_margin = better outcome. This is NOT causal — a candidate that sells early may also have other good properties. Use as a guide for what to test, not as a proven mechanism.

| action_type | early (days 1-14) | mid (days 15-21) | late (days 22-29) | total events |
|---|---|---:|---|---|---:|
| SELL |         +8,189 (n=21824) |         +8,139 (n=11312) |         +8,139 (n=12928) | 46064 |
| BUY_ANIMAL |         +7,770 (n=10715) |         +7,820 (n=2521) |              — (n=0) | 13236 |
| BUY_SEED |         +8,371 (n=17980) |         +8,127 (n=5963) |         +7,892 (n=2411) | 26354 |
| BUY_LAND |         +8,329 (n=6105) |         +7,982 (n=1176) |              — (n=0) | 7281 |
| BUY_PRODUCT |         +8,140 (n=24215) |         +8,139 (n=11312) |         +8,174 (n=11053) | 46580 |
| HIRE |         +8,184 (n=12221) |         +8,211 (n=5945) |         +8,528 (n=4077) | 22243 |
| WATER_MISSED |         +8,301 (n=19085) |         +8,139 (n=11312) |         +8,146 (n=12792) | 43189 |
  _Water missed = postponement signal. Negative = candidates that missed water had lower dev_margin._
| FEED_MISSED |         +7,911 (n=9749) |         +6,909 (n=2877) |         +7,548 (n=3537) | 16163 |
...
|---|---|---:|---:|---:|---:|---:|---:|
| SELL |      +8,281 |      +8,148 |      +7,770 |      +8,718 |      +8,002 |      +8,118 |
| BUY_ANIMAL |      +7,240 |           — |           — |         -35 |      +9,153 |      +7,685 |
| BUY_SEED |      +8,094 |      +8,676 |      +4,219 |      +2,158 |      +9,397 |      +8,219 |
| BUY_LAND |           — |      +3,080 |      +8,188 |      +1,344 |      +8,830 |      +8,320 |
| BUY_PRODUCT |      +8,148 |           — |           — |           — |           — |           — |
| HIRE |      +8,254 |           — |           — |           — |           — |           — |
| WATER_MISSED |           — |           — |      +8,139 |      +8,618 |      +8,139 |      +8,204 |
| FEED_MISSED |           — |      +8,157 |      +5,517 |           — |           — |      +7,617 |
...
|---|---|---:|---:|---:|---:|
| 1 | HIRE | late | +8,528 | 4077 | 1.82 |
| 2 | BUY_SEED | early | +8,371 | 17980 | 1.79 |
| 3 | BUY_LAND | early | +8,329 | 6105 | 1.73 |
| 4 | WATER_MISSED | early | +8,301 | 19085 | 1.77 |
| 5 | HIRE | mid | +8,211 | 5945 | 1.69 |
| 6 | SELL | early | +8,189 | 21824 | 1.72 |
| 7 | HIRE | early | +8,184 | 12221 | 1.7 |
| 8 | BUY_PRODUCT | late | +8,174 | 11053 | 1.7 |
| 9 | WATER_MISSED | late | +8,146 | 12792 | 1.69 |
| 10 | BUY_PRODUCT | early | +8,140 | 24215 | 1.69 |
...
- **FEED_MISSED** in ('low', 'low', 'low', 'high'): +9,310 (n=2201)
