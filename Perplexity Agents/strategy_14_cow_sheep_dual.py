# strategy_14_cow_sheep_dual.py
# Strategy #14: Cow + sheep dual ranch — $190.67/tile/day
# Two pastures, no crop tiles at all — one cow, one sheep, both fed and cared for every day.
#
# This agent focuses on:
# - early land purchase to secure 2 pasture slots,
# - buying and placing one cow and one sheep as early as feasible,
# - daily FEED + CARE for both animals,
...
def _animal_expansion_feasible(obs, view, budget, shed, n_animals, n_hands, quads, species):
    # Allow exactly 2 animals: one cow and one sheep.
...
def economy(obs, me, opp, view, seeds, day, hour, timing_engine, animal_plans):
    ...
    # Land expansion: aim for 2 tiles for 2 pastures.
    if 1 <= day <= 22:
        ...
        if quads == 1 and budget > 1000:
            ...
            # We only need 2 tiles total; skip further land buys.
            pass

    # Minimal wheat seed for feed cash flow.
    ph = phase(day)
    ...
    # Animal fleet: one cow, then one sheep.
