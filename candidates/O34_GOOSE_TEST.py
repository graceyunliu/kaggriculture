# O34_GOOSE_TEST: O26_CARROT_SIZING with geese knob turned on (4 GOOSE day 1) -- untested animal class, self-model 'produce' question, fast cycle (interval 1, cap 4) vs cow/sheep.
...
def economy(obs, v, pending_drop=None):
    ...
    if day == 0 and n_total == 0:
        ...
        if KNOBS["geese"] > 0 and day <= 10 and my_counts["GOOSE"] < KNOBS["geese"]:
