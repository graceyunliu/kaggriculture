...
KNOBS = {"melon_floor": 150, "harvest_min": 2, "opening": "frontier", "wheat_tiles": 7, "wheat_stock": 0, "min_hands": 3, "load_per_hand": 20, "geese": 0}
...
def economy(obs, v):
    ...
    if day == 0 and KNOBS["opening"] == "frontier" and n_total == 0:
        S["hires_target"] = 5
        return [["BUY_ANIMAL", "COW", 2], ["BUY_ANIMAL", "SHEEP", 2], ["BUY_SEED", "MELON", 12],
                ["BUY_SEED", "WHEAT", 7], ["BUY_PRODUCT", "WHEAT", 5],
