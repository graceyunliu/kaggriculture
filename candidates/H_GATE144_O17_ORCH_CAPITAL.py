# O17_ORCH_CAPITAL: O16_ORCH_ON_O15 (global crop orchestrator) + O16_CAPITAL_CHECKPOINT's cumulative capital-event trigger. Sep 10.
...
# ===== EVOLVE-BLOCK: hiring =====
HIRE_MAX_MARGINAL = 144   # refuse any hire whose own fibonacci price exceeds this (AGE-360 marginal ROI)
...
def economy(obs, v, pending_drop=None):
    ...
    # Stateful capital checkpoint (O16_CAPITAL_CHECKPOINT): accumulate cash changes since the last
