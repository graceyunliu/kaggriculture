...
O42_MAX_HANDS_LATE_EXPAND (day-gated MAX_HANDS 14->16 at day>=19) + O62/O67_CAPITAL_EVERY1H (full
per-turn economy checks every hour instead of once/day) + O68-O162 lineage (three-shop handling,
min_hands=2, capital_period knob live, etc.). Generated by Claude Sonnet 5 rebase session
01EemPgv7CKsEH5vP61UmC9N on Sep 16 2026. Rebuild: python3 evolve/blocks.py build.

This file is the frozen behavioral source of truth. evolve/blocks.py extracts typed mutation
blocks from this file into evolve/chassis.py. Do not edit directly -- edit the Claude session
that generated it, or edit evolve/chassis.py and back-propagate.
"""

import math
import random

# ---- engine constants (fixed, shared with all candidates) ----
VERSION = "O162_THREE_SHOPS65"
MAX_DAY = 29
