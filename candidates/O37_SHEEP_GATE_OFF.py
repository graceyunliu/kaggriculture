...
def economy(obs, v, pending_drop=None):
    ...
    if day == 0 and n_total == 0:
        ...
        for sp in ("SHEEP", "COW"):
            ...
            if sp == "SHEEP":
                # O37_SHEEP_GATE_OFF (Sep 12, causal probe): removed the yarn==0 / wool-price
                # readiness override that capped room at 2 regardless of _demand_room's estimate.
                # SHEEP now sizes off _demand_room alone, same as COW -- structural ablation of the
                # investment-readiness gate, not a hand-picked sheep count.
