# O38_MIN_HANDS2_FSP3: O36_MIN_HANDS2 (min_hands=2, already DO) with feed_spare_poor 0 -> 3 added on top.
# Tests whether feed_spare_poor=3 buys anything ON TOP OF the validated min_hands=2 mechanism (not vs O26).
# Dev h2h screen (10 seeds vs O26, Sep 11): combo(min_hands=2, feed_spare_poor=3) = +1,593, vs min_hands=2 alone +1,530.
# Panel comparator for this candidate is O36_MIN_HANDS2, per min_hands_knob_interactions DELAY resolving measurement.
