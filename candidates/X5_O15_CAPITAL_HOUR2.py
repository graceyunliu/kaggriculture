# X5: capital_hour2=2 (second full capital pass at h2). Margin gain on tapes is an INPUT-PRICE ATTACK (own money falls, opponent falls more) -- see RULES.md Sep 10 (late). Not a candidate.
