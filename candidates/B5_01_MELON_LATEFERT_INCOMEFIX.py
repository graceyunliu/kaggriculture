    ...
    if day == 0 and n_total == 0:
        ...
        for i_ in inv:
            for k_, n_ in i_.items():
                if k_ in ("MILK", "WOOL", "STRAWBERRY", "MELON", "EGG") or (k_ == "FERTILIZER" and not v["fert"]):
                    income_tomorrow += n_ * prices.get(k_, 0) * 0.8   # carried fertilizer bound for a tile is not income
