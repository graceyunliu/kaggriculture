# O33_LAND_DEADLINE_TIGHT: O26_CARROT_SIZING with LAND_DEADLINE pulled in 14/17/18 -> 11/13/14 per land_deadline_horizon (horizon_roi marginal BUY_LAND value decays to noise by day 12).
...
LAND_DEADLINE = {2: 11, 3: 13, 4: 14}      # Sep 11: pulled in from 14/17/18 per horizon_roi marginal decay to ~0 by day12 (land_deadline_horizon)
MAX_ORDERS = 10
