# O25_CAPITAL_PACED_CYCLE: O-lineage port of V3.29's one-shot early bundle deferral.
...
def economy(obs, v, pending_drop=None):
    ...
    # O25: port V3.29's one-shot early capital-pacing circuit breaker.
    # O16/O18 already cap livestock at 17, so V3.29's 20->18 cap is a no-op
    # on this lineage and is intentionally omitted.
