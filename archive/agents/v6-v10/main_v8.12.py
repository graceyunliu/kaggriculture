...
# =====================================================================
# MAIN V8.12 -- protected-crop-hand fraction tuned down, ISOLATED. Base:
# main_v8.3.py, byte-identical except for two constants (lines ~489-490):
#   PROTECTED_FRACTION_LOW:  0.50 -> 0.40
#   PROTECTED_FRACTION_HIGH: 0.70 -> 0.55
#
# --- Why ---
#
# v8.3 is the current champion (10/15 both-seats vs v8, +$1,894/game,
# 0 losses -- see kaggriculture-real-ladder-diagnosis.md). Its protected-
# crop-hand reservation (v7.6a mechanism, unchanged since) walls off
# 50-70% of hands for crop-only work every turn, which was sized to fix
# v7.5's crop-collapse failure mode -- but that fraction has never been
# re-tuned against v8.3's larger, sheep-inclusive fleet. Freeing 10pp off
# each band should hand back ~1-2 more hands/turn for animal (COW+SHEEP)
# maintenance without the crop side losing its floor protection.
#
# --- What could make this fail ---
#
# This is explicitly the failure mode the fraction was created to prevent:
# if freeing hands lets animal maintenance crowd out watering/weeding
# again, expect the v7.5 pattern (seed inventory freeze, weed count
# climbing, planted-crop tiles collapsing) to reappear. Watch WEED/HARVEST
# tile counts in the test replay; revert this change if it does.
#
# --- Test protocol ---
#   Seeded --both-seats vs main_v8.3.py, standard 15-seed set
#   (1,7,42,99,123,202,303,555,2024,8080,17,2025,3001,3002,3003).
# =====================================================================
#
# =====================================================================
...
PROTECTED_FRACTION_LOW = 0.40
PROTECTED_FRACTION_HIGH = 0.55
