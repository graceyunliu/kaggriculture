...
ANIMAL_SPECS = {
    ...
    "SHEEP": {"cost": 500, "min_money": 800, "start_day": 3,  "last_day": 15},
}
    ...
    if not in_progress:
        ...
        if target_plan is None:
            ...
            if (composition_wants_sheep and
                    _sheep_expansion_feasible(obs, view, budget, shed, n_animals, len(me["hands"]), quads)):
            ...
            elif _animal_expansion_feasible(obs, view, budget, shed, n_animals, len(me["hands"]), quads):
