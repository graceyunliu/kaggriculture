# LABOR EFFICIENCY AGENT 07: melon_eight_hands
# Base: main_v8.3.py
# Objective: Allocate a constrained workforce to a high-value, infrequent-harvest crop.
# Isolated policy changes: Eight-hand cap; melon-first portfolio; reduced crop variety.
...
def economy(obs, me, opp, view, seeds, day, hour, timing_engine, animal_plans):
    ...
    if day <= CUTOFF["MELON"] and budget > 700:
        melon_target = min(space, 14 if ph == 0 else 22)
