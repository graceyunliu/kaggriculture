# TURN EFFICIENCY AGENT 06: production_window_care
# Base: main_v8.3.py
# Objective: Spend care actions selectively rather than every eligible day.
# Isolated policy changes: Skip care every third day and skip fertilizer collection.
...
def animal_maintenance_action(pos, view, shed, carry, day, hour, exclude=(), critical_only=False):
    ...
    needs_care = (not critical_only) and (day % 3 != 0) and (not tile.get("cared_today", True))
