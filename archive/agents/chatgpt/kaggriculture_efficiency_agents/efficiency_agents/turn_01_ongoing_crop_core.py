# TURN EFFICIENCY AGENT 01: ongoing_crop_core
# Base: main_v8.3.py
# Objective: Maximize revenue per unit action by reducing harvest/replant cycles.
# Isolated policy changes: Prioritize strawberry/tomato; suppress short-cycle carrot and excess wheat.
