# TURN EFFICIENCY AGENT 03: wheat_batch_feed
# Base: main_v8.3.py
# Objective: Use simple four-day crop cycles and local feed to reduce market and routing actions.
# Isolated policy changes: Wheat-first planting; moderate cow window; sheep disabled.
...
ANIMAL_SPECS = {
    ...
    "COW":   {"cost": 400, "min_money": 700, "start_day": 0,  "last_day": 18},
...
PLANT_PRIORITY = ["WHEAT", "MELON", "STRAWBERRY", "TOMATO", "CARROT"]
...
def economy(obs, me, opp, view, seeds, day, hour, timing_engine, animal_plans):
    ...
    if day <= CUTOFF["MELON"] and budget > 700:
        melon_target = min(space, 5 if ph == 0 else 8)
    ...
    if day <= CUTOFF["STRAWBERRY"] and budget > 900:
        ...
        want["STRAWBERRY"] = min(space, 5 if ph == 0 else 8)
