# LABOR EFFICIENCY AGENT 03: ten_hand_cap
# Base: main_v8.3.py
# Objective: Seek a balanced labor frontier between v8.3 throughput and payroll footprint.
# Isolated policy changes: Hand target 4–10; maximum ten hires; six work units per target hand.
