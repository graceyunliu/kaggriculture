# LABOR EFFICIENCY AGENT 01: six_hand_cap
# Base: main_v8.3.py
# Objective: Maximize farm output per worker by imposing a hard six-hand ceiling.
# Isolated policy changes: Hand target 3–6; maximum six hires; expansion gates inherit the cap.
