# TURN EFFICIENCY AGENT 04: minimal_optional_animal_work
# Base: main_v8.3.py
# Objective: Reserve turns for mandatory feed, crop work, and harvest.
# Isolated policy changes: Disable animal care and fertilizer collection; retain v8.3 fleet economics.
