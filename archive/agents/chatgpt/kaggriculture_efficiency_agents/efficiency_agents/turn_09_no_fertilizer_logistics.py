# TURN EFFICIENCY AGENT 09: no_fertilizer_logistics
# Base: main_v8.3.py
# Objective: Eliminate collect, carry, deposit, and sale actions for a low-priority byproduct.
# Isolated policy changes: Fertilizer collection disabled; all other behavior unchanged.
