# TURN EFFICIENCY AGENT 07: compact_farm
# Base: main_v8.3.py
# Objective: Reduce walking turns by delaying expansion and keeping work near the shed.
# Isolated policy changes: Land purchases start day 8 and require an additional $2,000 reserve.
