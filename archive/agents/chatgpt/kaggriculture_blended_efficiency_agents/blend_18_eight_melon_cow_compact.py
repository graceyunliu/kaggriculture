# BLENDED EFFICIENCY AGENT 18: eight_melon_cow_compact
# Objective: jointly improve turn, land, and labor efficiency.
# Policy: 8 hands, melon emphasis, cow-only small fleet.
# Base: main_v8.3.py
...
#
# --- Why this isn't just flipping SHEEP_ENABLED = False ---
#
...
SHEEP_ENABLED = True
SHEEP_HAND_HEADROOM = 0   # extra hand-target ceiling allowed specifically
...
PLANT_PRIORITY = ['MELON', 'STRAWBERRY', 'WHEAT', 'TOMATO', 'CARROT']
...
def economy(obs, me, opp, view, seeds, day, hour, timing_engine, animal_plans):
    ...
    if day <= CUTOFF["MELON"] and budget > 700:
        melon_target = min(space, 10 if ph == 0 else 17)
    ...
    if day <= CUTOFF["TOMATO"] and budget > 600:
        want["TOMATO"] = 1   # ongoing crop, same small-standing-patch approach
