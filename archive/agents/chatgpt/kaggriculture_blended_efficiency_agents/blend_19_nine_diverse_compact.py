# BLENDED EFFICIENCY AGENT 19: nine_diverse_compact
# Objective: jointly improve turn, land, and labor efficiency.
# Policy: 9 hands, compact diversified crop and mixed fleet.
# Base: main_v8.3.py
...
ANIMAL_SPECS = {
    ...
    "COW":   {"cost": 400, "min_money": 700, "start_day": 0,  "last_day": 16},
    "SHEEP": {"cost": 500, "min_money": 800, "start_day": 3,  "last_day": 16},
}
...
def economy(obs, me, opp, view, seeds, day, hour, timing_engine, animal_plans):
    ...
    if day <= CUTOFF["MELON"] and budget > 700:
        melon_target = min(space, 8 if ph == 0 else 13)
    ...
    if day <= CUTOFF["STRAWBERRY"] and budget > 900:
        ...
        want["STRAWBERRY"] = min(space, 8 if ph == 0 else 13)
