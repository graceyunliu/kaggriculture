# BLENDED EFFICIENCY AGENT 06: ongoing8_compact
# Objective: jointly improve turn, land, and labor efficiency.
# Policy: 8 hands, compact land, ongoing crop core.
# Base: main_v8.3.py
...
def economy(obs, me, opp, view, seeds, day, hour, timing_engine, animal_plans):
    ...
    if day <= CUTOFF["STRAWBERRY"] and budget > 900:
        ...
        want["STRAWBERRY"] = min(space, 11 if ph == 0 else 18)
    if day <= CUTOFF["TOMATO"] and budget > 600:
        want["TOMATO"] = 6   # ongoing crop, same small-standing-patch approach
