...
NEAR_SHED_RADIUS = 6   # v10.5: Manhattan distance from the nearest shed
                        # tile (board is ~8-9 tiles across at most, so this
                        # roughly splits the farm into a near half and a
                        # far half)
