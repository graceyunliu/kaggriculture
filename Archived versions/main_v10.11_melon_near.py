...
# v10.11: v10.7's full 3-tier generalization was a decisive loss, but
# that changed several things at once (new mid tier, new radius, tie-
# breaking behavior for wheat/carrot too). This isolates just the
# smallest, most defensible piece of that idea: MELON's bonus window
# (ages 6-12, up to 7 possible waterings before its one harvest) is much
# closer to an ongoing crop's daily-revisit profile than WHEAT (ages
# 2-4, ~3 waterings) or CARROT (ages 2-3, ~2 waterings) -- simple
# set-membership addition, not a new tier system.
ONGOING_CROPS = {"STRAWBERRY", "TOMATO", "MELON"}
