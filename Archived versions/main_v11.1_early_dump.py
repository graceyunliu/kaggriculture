...
# v11.1 (Aug 7) -- EARLY/WIDER FORCE-DUMP TRIGGER, shed-capacity round.
...
# Mechanism: v10.6's force_dump only arms in the evening scramble, very
# close to full: `shed_load > SHED_CAP - 15 and hour >= 18`. This
# hypothesis fires the same emergency-relief mechanism much earlier and
# across a wider fraction of the day, catching overflow risk mid-day
# instead of only after most of the day's selling opportunities are gone:
# `shed_load > SHED_CAP - 35 and hour >= 10`.
force_dump_threshold = SHED_CAP - 35
force_dump_hour_floor = 10
...
def economy(obs, me, opp, view, seeds, day, hour, timing_engine, animal_plans):
    ...
    # v11.1: was `shed_load > SHED_CAP - 15 and hour >= 18` -- fires only
    # in the evening scramble, very close to full. Widened to trigger
    # proactively much earlier in the day and at a lower fullness bar.
    force_dump = shed_load > force_dump_threshold and hour >= force_dump_hour_floor
