...
# gates run unbounded."
EXPERIMENT_MAX_FLEET = 14  # v10.15 hypothesis: Grace's ladder observation
                            # (top players never buy the 4th quadrant)
                            # matches EXACTLY what's already known about
                            # the fixed-tape clone opponents in this
                            # project's own history -- opp_scenario_v14/
                            # opp_frontier_v12 buy land NE day7 + SW day10
                            # and STOP at 3 quadrants, running an 8 COW +
                            # 6 SHEEP = 14-animal fleet (vs our 10-cap).
                            # The old "12+ saturates the hand pool" finding
                            # (v9.1 iter C) was measured on the FULL
                            # 4-quadrant board, where hands were also
                            # servicing SE's crop-land. On a 3-quadrant
                            # board (v10.14's SE skip), there's ~25% less
                            # crop-land competing for the same hands --
                            # re-testing whether the old ceiling still
                            # binds now that land is capped too.
