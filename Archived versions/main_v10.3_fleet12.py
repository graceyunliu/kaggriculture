...
# gates run unbounded."
EXPERIMENT_MAX_FLEET = 12  # v10.3 re-test: the 12+ saturation finding (v9.1
                            # iter C) predates v9.21's build-slot-loop fix
                            # and v9.22's MAX_CONCURRENT_BUILDS 3->6 raise,
                            # both of which specifically target fleet-growth
                            # throughput. Re-testing whether the ceiling
                            # still holds now that the support machinery it
                            # saturated has since been upgraded.
